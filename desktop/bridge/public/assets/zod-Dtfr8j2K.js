...
(function (r) {
  ...
  ((r.joinValues = s),
    (r.jsonStringifyReplacer = (a, n) => (typeof n == "bigint" ? n.toString() : n)));
})(y || (y = {}));
var ee;
(function (r) {
...
function c(r, e) {
  const t = xe(),
    s = ke({
      ...
      data: r.data,
      path: r.path,
      errorMaps: [r.common.contextualErrorMap, r.schemaErrorMap, t, t === J ? void 0 : J].filter(
        (a) => !!a,
      ),
    });
...
class g {
  ...
  refine(e, t) {
    ...
    return this._refinement((a, n) => {
      const i = e(a),
        o = () => n.addIssue({ code: d.custom, ...s(a) });
...
function Pe(r, e) {
  return !!(((e === "v4" || !e) && Re.test(r)) || ((e === "v6" || !e) && je.test(r)));
}
function De(r, e) {
...
function Ue(r, e) {
  return !!(((e === "v4" || !e) && Ie.test(r)) || ((e === "v6" || !e) && Ee.test(r)));
}
class O extends g {
  _parse(e) {
    ...
    for (const n of this._def.checks)
      if (n.kind === "min")
        ...
        Ae.test(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          c(a, { validation: "email", code: d.invalid_string, message: n.message }),
          s.dirty());
      else if (n.kind === "emoji")
        (q || (q = new RegExp(Ze, "u")),
          q.test(e.data) ||
            ((a = this._getOrReturnCtx(e, a)),
            c(a, { validation: "emoji", code: d.invalid_string, message: n.message }),
            s.dirty()));
      else if (n.kind === "uuid")
        Te.test(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          c(a, { validation: "uuid", code: d.invalid_string, message: n.message }),
          s.dirty());
      else if (n.kind === "nanoid")
        Oe.test(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          c(a, { validation: "nanoid", code: d.invalid_string, message: n.message }),
          s.dirty());
      else if (n.kind === "cuid")
        be.test(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          c(a, { validation: "cuid", code: d.invalid_string, message: n.message }),
          s.dirty());
      else if (n.kind === "cuid2")
        we.test(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          c(a, { validation: "cuid2", code: d.invalid_string, message: n.message }),
          s.dirty());
      else if (n.kind === "ulid")
        Ce.test(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          c(a, { validation: "ulid", code: d.invalid_string, message: n.message }),
          s.dirty());
      else if (n.kind === "url")
        try {
          new URL(e.data);
          ...
          ((a = this._getOrReturnCtx(e, a)),
            c(a, { validation: "url", code: d.invalid_string, message: n.message }),
            s.dirty());
        }
      else
        n.kind === "regex"
          ? ((n.regex.lastIndex = 0),
            n.regex.test(e.data) ||
              ((a = this._getOrReturnCtx(e, a)),
              c(a, { validation: "regex", code: d.invalid_string, message: n.message }),
              s.dirty()))
          : n.kind === "trim"
            ? (e.data = e.data.trim())
            : n.kind === "includes"
...
class j extends g {
        ...
        : n.kind === "min"
          ...
          : n.kind === "max"
            ...
            : n.kind === "multipleOf"
              ? Be(e.data, n.value) !== 0 &&
                ((s = this._getOrReturnCtx(e, s)),
                c(s, { code: d.not_multiple_of, multipleOf: n.value, message: n.message }),
                a.dirty())
              : n.kind === "finite"
                ? Number.isFinite(e.data) ||
                  ((s = this._getOrReturnCtx(e, s)),
                  c(s, { code: d.not_finite, message: n.message }),
                  a.dirty())
                : y.assertNever(n);
  ...
  setLimit(e, t, s, a) {
    return new j({
      ...this._def,
      checks: [...this._def.checks, { kind: e, value: t, inclusive: s, message: l.toString(a) }],
    });
  }
  _addCheck(e) {
...
j.create = (r) => new j({ checks: [], typeName: p.ZodNumber, coerce: r?.coerce || !1, ..._(r) });
class z extends g {
  constructor() {
...
class Y extends g {
  _parse(e) {
    if ((this._def.coerce && (e.data = !!e.data), this._getType(e) !== u.boolean)) {
      ...
      return (c(s, { code: d.invalid_type, expected: u.boolean, received: s.parsedType }), m);
    }
    return b(e.data);
  }
}
Y.create = (r) => new Y({ typeName: p.ZodBoolean, coerce: r?.coerce || !1, ..._(r) });
class U extends g {
  _parse(e) {
...
U.create = (r) => new U({ checks: [], coerce: r?.coerce || !1, typeName: p.ZodDate, ..._(r) });
class ae extends g {
  _parse(e) {
    if (this._getType(e) !== u.symbol) {
      const s = this._getOrReturnCtx(e);
      return (c(s, { code: d.invalid_type, expected: u.symbol, received: s.parsedType }), m);
    }
    return b(e.data);
  }
}
ae.create = (r) => new ae({ typeName: p.ZodSymbol, ..._(r) });
class ne extends g {
  _parse(e) {
    if (this._getType(e) !== u.undefined) {
      const s = this._getOrReturnCtx(e);
      return (c(s, { code: d.invalid_type, expected: u.undefined, received: s.parsedType }), m);
    }
    return b(e.data);
  }
}
ne.create = (r) => new ne({ typeName: p.ZodUndefined, ..._(r) });
class ie extends g {
  _parse(e) {
    if (this._getType(e) !== u.null) {
      const s = this._getOrReturnCtx(e);
      return (c(s, { code: d.invalid_type, expected: u.null, received: s.parsedType }), m);
    }
    return b(e.data);
  }
}
ie.create = (r) => new ie({ typeName: p.ZodNull, ..._(r) });
class oe extends g {
  constructor() {
...
de.create = (r) => new de({ typeName: p.ZodUnknown, ..._(r) });
class A extends g {
  _parse(e) {
    const t = this._getOrReturnCtx(e);
...
class ce extends g {
  _parse(e) {
    if (this._getType(e) !== u.undefined) {
      const s = this._getOrReturnCtx(e);
      return (c(s, { code: d.invalid_type, expected: u.void, received: s.parsedType }), m);
    }
    return b(e.data);
  }
}
ce.create = (r) => new ce({ typeName: p.ZodVoid, ..._(r) });
class w extends g {
  _parse(e) {
    const { ctx: t, status: s } = this._processInputParams(e),
      a = this._def;
    if (t.parsedType !== u.array)
      return (c(t, { code: d.invalid_type, expected: u.array, received: t.parsedType }), m);
    ...
    if (
      ...
      return Promise.all(
        [...t.data].map((i, o) => a.type._parseAsync(new N(t, i, t.path, o))),
...
class x extends g {
  ...
  _parse(e) {
    ...
    if (!(this._def.catchall instanceof A && this._def.unknownKeys === "strip"))
      for (const f in a.data) i.includes(f) || o.push(f);
    const h = [];
    for (const f of i) {
      const v = n[f],
        M = a.data[f];
      h.push({
        ...
        value: v._parse(new N(a, M, a.path, f)),
    ...
    if (this._def.catchall instanceof A) {
      ...
      if (f === "passthrough")
        ...
        o.length > 0 && (c(a, { code: d.unrecognized_keys, keys: o }), s.dirty());
      else if (f !== "strip")
      ...
      for (const v of o) {
        ...
        h.push({
          key: { status: "valid", value: v },
          value: f._parse(new N(a, M, a.path, v)),
      ...
      ? Promise.resolve()
          .then(async () => {
            ...
            for (const v of h) {
              const M = await v.key,
                ye = await v.value;
              f.push({ key: M, value: ye, alwaysSet: v.alwaysSet });
            }
            return f;
          })
...
x.lazycreate = (r, e) =>
  new x({ shape: r, unknownKeys: "strip", catchall: A.create(), typeName: p.ZodObject, ..._(e) });
class B extends g {
  _parse(e) {
...
function H(r, e) {
  ...
  if (t === u.object && s === u.object) {
    const a = y.objectKeys(e),
      n = y.objectKeys(r).filter((o) => a.indexOf(o) !== -1),
      i = { ...r, ...e };
    for (const o of n) {
      const h = H(r[o], e[o]);
  ...
  _parse(e) {
    const { status: t, ctx: s } = this._processInputParams(e),
      a = (n, i) => {
        ...
        return o.valid
          ? ((se(n) || se(i)) && t.dirty(), { status: t.value, value: o.data })
          : (c(s, { code: d.invalid_intersection_types }), m);
      };
...
F.create = (r, e, t) => new F({ left: r, right: e, typeName: p.ZodIntersection, ..._(t) });
class Z extends g {
  _parse(e) {
    const { status: t, ctx: s } = this._processInputParams(e);
    if (s.parsedType !== u.array)
      return (c(s, { code: d.invalid_type, expected: u.array, received: s.parsedType }), m);
...
class ue extends g {
  ...
  _parse(e) {
    ...
    if (s.parsedType !== u.map)
      return (c(s, { code: d.invalid_type, expected: u.map, received: s.parsedType }), m);
...
ue.create = (r, e, t) => new ue({ valueType: e, keyType: r, typeName: p.ZodMap, ..._(t) });
class P extends g {
  _parse(e) {
    const { status: t, ctx: s } = this._processInputParams(e);
    if (s.parsedType !== u.set)
      return (c(s, { code: d.invalid_type, expected: u.set, received: s.parsedType }), m);
    const a = this._def;
    (a.minSize !== null &&
    ...
    const o = [...s.data.values()].map((h, f) => n._parse(new N(s, h, s.path, f)));
    return s.common.async ? Promise.all(o).then((h) => i(h)) : i(o);
  }
  min(e, t) {
    return new P({ ...this._def, minSize: { value: e, message: l.toString(t) } });
  }
  max(e, t) {
    return new P({ ...this._def, maxSize: { value: e, message: l.toString(t) } });
  }
  size(e, t) {
...
P.create = (r, e) =>
  new P({ valueType: r, minSize: null, maxSize: null, typeName: p.ZodSet, ..._(e) });
class le extends g {
  get schema() {
...
le.create = (r, e) => new le({ getter: r, typeName: p.ZodLazy, ..._(e) });
class he extends g {
  _parse(e) {
...
he.create = (r, e) => new he({ value: r, typeName: p.ZodLiteral, ..._(e) });
function ge(r, e) {
...
class E extends g {
  _parse(e) {
    if (typeof e.data != "string") {
      const t = this._getOrReturnCtx(e),
        s = this._def.values;
      return (c(t, { expected: y.joinValues(s), received: t.parsedType, code: d.invalid_type }), m);
    }
    if ((this._cache || (this._cache = new Set(this._def.values)), !this._cache.has(e.data))) {
      const t = this._getOrReturnCtx(e),
        s = this._def.values;
      return (c(t, { received: t.data, code: d.invalid_enum_value, options: s }), m);
    }
    return b(e.data);
  }
  get options() {
...
class fe extends g {
  _parse(e) {
    ...
    if (s.parsedType !== u.string && s.parsedType !== u.number) {
      ...
      return (c(s, { expected: y.joinValues(a), received: s.parsedType, code: d.invalid_type }), m);
    }
    if (
      (this._cache || (this._cache = new Set(y.getValidEnumValues(this._def.values))),
      !this._cache.has(e.data))
    ) {
      const a = y.objectValues(t);
      return (c(s, { received: s.data, code: d.invalid_enum_value, options: a }), m);
    }
    return b(e.data);
  }
  get enum() {
...
class W extends g {
  ...
  _parse(e) {
    ...
    if (t.parsedType !== u.promise && t.common.async === !1)
      return (c(t, { code: d.invalid_type, expected: u.promise, received: t.parsedType }), m);
    ...
    if (((n.addIssue = n.addIssue.bind(n)), a.type === "preprocess")) {
      ...
      if (s.common.async)
        return Promise.resolve(i).then(async (o) => {
          ...
          const h = await this._def.schema._parseAsync({ data: o, path: s.path, parent: s });
...
class me extends g {
  _parse(e) {
    if (this._getType(e) !== u.nan) {
      const s = this._getOrReturnCtx(e);
      return (c(s, { code: d.invalid_type, expected: u.nan, received: s.parsedType }), m);
    }
    return { status: "valid", value: e.data };
  }
}
...
S.create;
V.create;
export { Je as b, Ge as e, qe as n, Ye as o, We as s, He as u };
