...
import { b as te } from "./index-BF1LFLDu.js";
import {
  E as se,
  g as ae,
  aN as re,
...
function Qe() {
  const [i, oe] = a.useState("owner"),
    ...
    [j, B] = a.useState(0),
    [h, E] = a.useState(!1),
    [d, be] = a.useState(null),
    [v, U] = a.useState([]),
    ue = () => {
      if (h) (clearInterval(d), E(!1));
      else {
        const t = Date.now() - j,
          s = setInterval(() => {
            B(Date.now() - t);
    ...
    M = (t) => {
      const s = Math.floor(t / 36e5),
        ...
        N = Math.floor((t % 1e3) / 10),
        c = (F, k = 2) => F.toString().padStart(k, "0");
      return `${c(s)}:${c(l)}:${c(n)}.${c(N, 2)}`;
    };
  a.useEffect(
    () => () => {
      d && clearInterval(d);
  ...
  const [y, Ne] = a.useState("https://abcdefghijklm.supabase.co"),
    [w, je] = a.useState("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJp..."),
    [T, Ee] = a.useState("PITWALL-A1B2"),
    [p, ve] = a.useState("Danny M"),
    [x, ye] = a.useState("PITWALL-A1B2"),
    [Y, Ge] = a.useState("https://abcdefghijklm.supabase.co"),
    [G, We] = a.useState("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJp..."),
    [W, V] = a.useState(!1),
    [H, $] = a.useState(!1),
    [S, q] = a.useState([]),
    [K, z] = a.useState(!1),
    ...
    Te = () => {
      if (m) {
        (clearInterval(b),
          Q(!1),
          u((n) => [...n, "[team-relay] ✗ Broadcast server stopped manually. Channel idle."]));
        return;
      }
      (Q(!0),
        (f.current = 0),
        u([
          `[team-relay] * Initializing iRacing API reader (driver identification: "${p || "ANON_DRIVER"}")...`,
      ...
      const t = [
        ...
        `[team-relay] * Establishing connection with Supabase Relay (channel: team:${x || "PITWALL-A1B2"})...`,
        "[team-relay] ✓ Handshake verified. Row Security status: AUTHORIZED ANON_PUBLIC",
        `[team-relay] * Connected to channel "team:${x || "PITWALL-A1B2"}" -- publishing at 2Hz`,
      ];
      let s = 0;
      const l = setInterval(() => {
        if (s < t.length) (u((n) => [...n, t[s]]), s++);
        else {
          const n = Math.floor(220 + Math.random() * 45),
            N = n > 240 ? 6 : 5,
            c = Math.floor(6200 + Math.random() * 1100),
            F = (42.1 - f.current * 0.04).toFixed(2),
            k = (f.current * 0.5).toFixed(1);
          (u((Le) => {
            const A = [
              ...Le,
              `[team-relay] [T+${k}s] PUBLISHING -> SPEED: ${n} km/h | GEAR: ${N} | RPM: ${c} | FUEL: ${F}L | TYRES_OK: true`,
            ];
            return (A.length > 60 && A.shift(), A);
          }),
            f.current++);
        }
      }, 500);
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.team_sessions;`),
    ...
    Ce = () => {
      ...
      let s = 0;
      const l = setInterval(() => {
        s < t.length ? (q((n) => [...n, t[s]]), s++) : (clearInterval(l), $(!1));
      }, 400);
    },
    ee = (t) => {
      const c = `SUPABASE_URL=${t ? y : Y}
SUPABASE_ANON_KEY=${t ? w : G}
TEAM_CODE=${t ? T : x}
DRIVER_NAME=${t ? "" : p}`;
      (navigator.clipboard.writeText(c),
        t ? (z(!0), setTimeout(() => z(!1), 2e3)) : (J(!0), setTimeout(() => J(!1), 2e3)));
    },
    [r, g] = a.useState("fuel"),
    [o, Fe] = a.useState("err01"),
    ke = (t) => {
      switch (t) {
        case "err01":
              ...
              e.jsx("div", {
                ...
                children: [
                  ...
                  return e.jsxs(
                    ...
                    {
                      onClick: () => oe(t.id),
                      className: `p-2.5 rounded-none border transition-all text-left relative cursor-pointer group flex items-start gap-2.5 ${s ? "bg-[#3B82F6]/5 border-[#3B82F6]/55 shadow-[0_0_8px_rgba(59,130,246,0.1)]" : "bg-[#05070a]/60 border-[#1c2430] hover:border-[#7a828c]/40 hover:bg-[#11161d]"}`,
                      children: [
                        s &&
                          e.jsx("div", {
                        ...
                        e.jsx("div", {
                          ...
                          style: { color: s ? t.color : "#7a828c" },
                          children: e.jsx(t.icon, { className: "w-4 h-4" }),
                        }),
                        e.jsxs("div", {
                        ...
                        e.jsx(_e, {
                          className: `w-3.5 h-3.5 mt-1 shrink-0 transition-transform ${s ? "text-white translate-x-0.5" : "text-[#7a828c] opacity-0 group-hover:opacity-100"}`,
                        }),
                      ],
                    },
                    t.id,
              ...
              e.jsxs("div", {
                ...
                children: [
                  ...
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("span", { className: "text-[#7a828c]", children: "FREQUENCY:" }),
                      e.jsx("span", {
                  ...
                  e.jsxs("div", {
                    className: "flex justify-between border-b border-[#1c2430]/50 pb-0.5",
                    children: [
                      e.jsx("span", { className: "text-[#7a828c]", children: "DB RELAY:" }),
                      e.jsx("span", {
                  ...
                  e.jsxs("div", {
                    className: "flex justify-between border-b border-[#1c2430]/50 pb-0.5",
                    children: [
                      e.jsx("span", { className: "text-[#7a828c]", children: "AUTHENTICATION:" }),
                      e.jsx("span", {
                        className: "text-white font-bold",
                  ...
                  e.jsxs("div", {
                    className: "flex justify-between border-b border-[#1c2430]/50 pb-0.5",
                    children: [
                      e.jsx("span", { className: "text-[#7a828c]", children: "iRSDK BRIDGE:" }),
                      e.jsx("span", {
                  ...
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("span", { className: "text-[#7a828c]", children: "CHANNEL METRIC:" }),
                      e.jsx("span", {
                      ...
                      children: [
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsx(se, { className: "w-5 h-5 text-[#FFB800] shrink-0 mt-0.5" }),
                            e.jsxs("div", {
                              children: [
                                e.jsx("h4", {
                                  className:
                                    ...
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        e.jsxs("span", {
                                          ...
                                          children: [
                                            e.jsx(Oe, { className: "w-3.5 h-3.5 text-[#FFB800]" }),
                                            ...
                                            e.jsxs(
                                              "div",
                                              {
                                                ...
                                                children: [
                                                  ...
                                                  e.jsx("span", {
                                                    className:
                                                      t.includes("SUCCESS") || t.includes("success")
                                                        ? "text-[#00D17F]"
                                                        : "",
                                                    children: t,
                                                  }),
                                    ...
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        ...
                                        e.jsxs("button", {
                                          ...
                                          children: [
                                            K
                                              ? e.jsx(R, { className: "w-3 h-3 text-[#00D17F]" })
                                              : e.jsx(I, { className: "w-3 h-3" }),
                                            K ? "COPIED .ENV FILE" : "COPY FILE CONTENT",
                                          ],
                                        }),
                                      ],
                                    }),
                      ...
                      children: [
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsx(ae, { className: "w-5 h-5 text-[#FF4D4D] shrink-0 mt-0.5" }),
                            e.jsxs("div", {
                              children: [
                                e.jsx("h4", {
                                  className:
                                ...
                                e.jsxs("div", {
                                  ...
                                  children: [
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        e.jsx(Pe, { className: "w-3.5 h-3.5 text-[#FF4D4D]" }),
                                        "Node Server Console — local-bridge/server.js",
                                      ],
                                    }),
                                    e.jsxs("button", {
                                      onClick: Te,
                                      className: `text-[7.5px] px-2 py-0.5 rounded-none font-bold border transition-all cursor-pointer flex items-center gap-1 ${m ? "bg-red-950/40 text-[#FF4D4D] border-[#FF4D4D]/25" : "bg-[#00D17F]/10 text-[#00D17F] border-[#00D17F]/30"}`,
                                      children: [
                                        m
                                          ? e.jsx(Be, {
                                              className: "w-3 h-3 text-[#FF4D4D] animate-pulse",
                                            })
                                          : e.jsx(le, { className: "w-3 h-3 text-[#00D17F]" }),
                                        m ? "TERMINATE TRANSMITTER" : "RUN TELEMETRY BRIDGE",
                                      ],
                                    }),
                                  ],
                                }),
                      ...
                      children: [
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsx(re, { className: "w-5 h-5 text-[#3B82F6] shrink-0 mt-0.5" }),
                            e.jsxs("div", {
                              children: [
                                e.jsx("h4", {
                                  className:
                                      ...
                                      children: [
                                        ...
                                        e.jsxs("div", {
                                          ...
                                          children: [
                                            e.jsxs("div", {
                                              onMouseEnter: () => g("fuel"),
                                              className: `p-2 border transition-all cursor-pointer ${r === "fuel" ? "bg-[#3B82F6]/5 border-[#3B82F6]" : "bg-[#0b0f14] border-[#1c2430]"}`,
                                              children: [
                                                e.jsx("span", {
                                                  className:
                                            ...
                                            e.jsxs("div", {
                                              onMouseEnter: () => g("gearSpeed"),
                                              className: `p-2 border transition-all cursor-pointer ${r === "gearSpeed" ? "bg-[#3B82F6]/5 border-[#3B82F6]" : "bg-[#0b0f14] border-[#1c2430]"}`,
                                              children: [
                                                e.jsx("span", {
                                                  className:
                                                    "text-[7px] text-[#7a828c] uppercase font-bold block",
                                        ...
                                        e.jsxs("div", {
                                          onMouseEnter: () => g("tyreTemps"),
                                          className: `p-2 border transition-all cursor-pointer ${r === "tyreTemps" ? "bg-[#3B82F6]/5 border-[#3B82F6]" : "bg-[#0b0f14] border-[#1c2430]"}`,
                                          children: [
                                            e.jsxs("div", {
                                        ...
                                        e.jsxs("div", {
                                          onMouseEnter: () => g("tyreWear"),
                                          className: `p-2 border transition-all cursor-pointer ${r === "tyreWear" ? "bg-[#3B82F6]/5 border-[#3B82F6]" : "bg-[#0b0f14] border-[#1c2430]"}`,
                                          children: [
                                            e.jsxs("div", {
                                              className: "flex justify-between items-center mb-1",
                                              children: [
                                ...
                                e.jsxs("div", {
                                  ...
                                  children: [
                                    e.jsxs("div", {
                                      children: [
                                        e.jsxs("span", {
                                          ...
                                          children: [
                                            r === "fuel" && "⛽ FUEL EXPECTANCY METRICS",
                                            r === "gearSpeed" && "⚙️ POWERTRAIN ANALYSIS",
                                            r === "tyreTemps" && "🔥 TYRE THERMAL ENVELOPE",
                                            r === "tyreWear" && "📊 Compound Degradation limits",
                                          ],
                                        }),
                                        e.jsxs("div", {
                                    ...
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        e.jsx("span", { children: "DATA QUALITY: iRSDK RAW FEED" }),
                                        e.jsx("span", { children: "UPDATE RATIO: 2HZ" }),
                                      ],
                                    }),
                                  ],
                                }),
                      ...
                      children: [
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsx(ne, { className: "w-5 h-5 text-[#94A3B8] shrink-0 mt-0.5" }),
                            e.jsxs("div", {
                              children: [
                                e.jsx("h4", {
                                  className:
                            ...
                            e.jsxs("div", {
                              ...
                              children: [
                                e.jsxs("div", {
                                  ...
                                  children: [
                                    e.jsx("span", { children: "Diagnostic STDOUT Logger" }),
                                    e.jsx("span", {
                      ...
                      children: [
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsx(ie, { className: "w-5 h-5 text-[#00D17F] shrink-0 mt-0.5" }),
                            e.jsxs("div", {
                              children: [
                                e.jsx("h4", {
                                  className:
                              ...
                              children: [
                                ...
                                [
                                  ...
                                  e.jsxs(
                                    "div",
                                    {
                                      className: `grid grid-cols-12 px-2.5 py-1.5 border-b border-[#1c2430]/40 last:border-0 ${s % 2 === 0 ? "bg-[#05070a]/40" : "bg-[#0b0f14]"}`,
                                      children: [
                                        e.jsx("div", {
                                          className:
          ...
          e.jsxs("section", {
            ...
            children: [
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs("div", {
                    className: `space-y-2 p-1.5 border transition-all ${i === "owner" ? "bg-[#FFB800]/5 border-[#FFB800]/25" : "border-transparent"}`,
                    children: [
                      e.jsx("span", {
                        className:
                        ...
                        children: [
                          ...
                          e.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                _[t.id]
                                  ? e.jsx(D, { className: "w-3 h-3 text-[#00D17F] shrink-0" })
                                  : e.jsx(L, { className: "w-3 h-3 text-[#7a828c] shrink-0" }),
                                e.jsx("span", {
                                  className: _[t.id] ? "line-through text-[#7a828c] font-bold" : "",
                                  children: t.label,
                                }),
                              ],
                            },
                  ...
                  e.jsxs("div", {
                    className: `space-y-2 p-1.5 border transition-all ${i === "driver" ? "bg-[#FF4D4D]/5 border-[#FF4D4D]/25" : "border-transparent"}`,
                    children: [
                      e.jsx("span", {
                        className:
                            ...
                            "div",
                            {
                              ...
                              children: [
                                O[t.id]
                                  ...
                                  : e.jsx(L, { className: "w-3 h-3 text-[#7a828c] shrink-0" }),
                                e.jsx("span", {
                                  className: O[t.id] ? "line-through text-[#7a828c] font-bold" : "",
                                  children: t.label,
                                }),
                              ],
                            },
                  ...
                  e.jsxs("div", {
                    className: `space-y-2 p-1.5 border transition-all ${i === "crew" ? "bg-[#3B82F6]/5 border-[#3B82F6]/25" : "border-transparent"}`,
                    children: [
                      e.jsx("span", {
                        className:
                            ...
                            "div",
                            {
                              ...
                              children: [
                                P[t.id]
                                  ...
                                  : e.jsx(L, { className: "w-3 h-3 text-[#7a828c] shrink-0" }),
                                e.jsx("span", {
                                  className: P[t.id] ? "line-through text-[#7a828c] font-bold" : "",
                                  children: t.label,
                                }),
                              ],
                            },
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs("span", {
                    ...
                    children: [
                      e.jsx(Ye, { className: "w-3.5 h-3.5 text-[#3B82F6]" }),
                  ...
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("button", {
                        type: "button",
                        onClick: ue,
                        className: `py-1 text-[7.5px] uppercase tracking-widest font-bold rounded-none cursor-pointer transition-all border ${h ? "bg-red-950/20 text-[#FF4D4D] border-red-500/25 hover:bg-red-950/40" : "bg-[#00D17F]/10 text-[#00D17F] border-[#00D17F]/30 hover:bg-[#00D17F]/20"}`,
                          ...
                          e.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                e.jsxs("span", {
                                  className: "text-[#7a828c]",
                                  children: ["LAP ", v.length - s],
                                }),
                                e.jsx("span", { className: "text-white font-bold", children: t }),
                              ],
                            },
                            s,
                          ),
      ...
      e.jsxs("footer", {
        ...
        children: [
          e.jsxs("div", {
            className: "flex items-center gap-1.5",
            children: [
              e.jsx("span", { className: "size-1 bg-[#00D17F] rounded-full animate-pulse" }),
              e.jsx("span", { children: "RELAY STATE: IDLE" }),
            ],
          }),
          e.jsx("div", { children: "iRacing Team Relay Companion · 2026" }),
          e.jsx("div", { children: "PIT WALL // SECURE CLIENT RELAY SYSTEM" }),
        ],
      }),
    ],
  });
