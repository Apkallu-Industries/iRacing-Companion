...
import { R as Route, N as useWorkbench } from "./router-D8VllJ-f.js";
...
import {
  ...
  S as SectorSpider,
  g as getSharedLap,
  r as refreshSharedSignedUrl,
} from "./SectorSpider-B2zpDSl9.js";
import { ReplayThree } from "./ReplayThree-Cbj-PYIC.js";
import { Timeline } from "./Timeline-CZTaAxWk.js";
import "seroval";
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              refLap != null &&
                /* @__PURE__ */ jsxs("span", {
                  className: "text-muted-foreground",
                  children: ["· Ref L", refLap],
                }),
              cmpLap != null &&
                /* @__PURE__ */ jsxs("span", {
                  className: "text-muted-foreground",
                  children: ["vs L", cmpLap],
                }),
            ],
          }),
          /* @__PURE__ */ jsx(Link, {
        ...
        : /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx("div", {
                ...
                children: ["map", "3d", "piano", "spider"].map((t) =>
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: () => setTab(t),
                      className: `px-4 py-2 ${tab === t ? "bg-panel text-foreground" : "bg-rail text-muted-foreground hover:text-foreground"}`,
                      children:
                        t === "map"
                          ? "Track Map"
                          : t === "3d"
...
export { SharedLapPage as component };
