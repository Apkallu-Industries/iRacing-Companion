...
const fetchTrackCarHistory = createServerFn({
  ...
  .handler(fetchTrackCarHistory_createServerFn_handler, async ({ data, context }) => {
...
const recordTelemetrySessionMeta = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .inputValidator((data) => data)
  .handler(recordTelemetrySessionMeta_createServerFn_handler, async ({ data, context }) => {
    let localId = null;
...
const fetchLocalTelemetryFile = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .inputValidator((data) => data)
  .handler(fetchLocalTelemetryFile_createServerFn_handler, async ({ data, context }) => {
    try {
      const db = await connectToLocalDb();
