...
const recordLiveLap = createServerFn({
  ...
  .handler(recordLiveLap_createServerFn_handler, async ({ data, context }) => {
...
const getPersonalBest = createServerFn({
  ...
  .handler(getPersonalBest_createServerFn_handler, async ({ data, context }) => {
...
export { getPersonalBest_createServerFn_handler, recordLiveLap_createServerFn_handler };
