...
import { RotateCcw, X, Settings, SkipBack, Rewind, Pause, Play, FastForward, SkipForward } from "lucide-react";
import { c as catalogEntry } from "./sessions._id-CAJaAE3T.js";
...
import "./histogramUtils-BFnLEpO8.js";
import "./registry-E60JHNYO.js";
import "./AppHeader-D6w9EARN.js";
...
import "uplot";
import "./SectorSpider-BJK78UEG.js";
import "./setup-CA-YNL5H.js";
import "./fingerprint.functions-YOm-UIzx.js";
...
function HudSettings({ parsed, onClose }) {
  ...
  const update = (slot, value) => setPrefs({ ...prefs, config: { ...prefs.config, [slot]: value } });
  return /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-20 flex items-stretch justify-end bg-background/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "hairline-b flex items-center justify-between px-3 py-2 font-mono text-[11px] uppercase tracking-wider", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hairline-b flex items-center justify-between gap-3 px-3 py-2 font-mono text-[11px]", children: [
          /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Speed unit" }),
          /* @__PURE__ */ jsx("div", { className: "flex gap-px overflow-hidden rounded-sm border border-border", children: ["kmh", "mph", "ms"].map((u) => /* @__PURE__ */ jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsx("div", { className: "min-h-0 flex-1 overflow-y-auto p-2", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-2", children: Object.keys(HUD_SLOT_LABELS).map((slot) => {
            ...
            "label",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "uppercase tracking-wider text-muted-foreground", children: meta.label }),
                  !present && /* @__PURE__ */ jsx("span", { className: "rounded-sm bg-destructive/20 px-1.5 py-0.5 text-[9px] uppercase text-destructive-foreground", children: "not in file" })
                ] }),
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      ...
                      channelNames.map((n) => /* @__PURE__ */ jsx("option", { value: n, children: n }, n))
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs("div", { className: "mt-1 text-[10px] normal-case tracking-normal text-muted-foreground", children: [
                  meta.hint,
                  ch && /* @__PURE__ */ jsxs(Fragment, { children: [
                    " ",
                    "· range ",
                    ch.min.toFixed(2),
                    "–",
                  ...
                  cat && cat.desc !== meta.hint && /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx("br", {}),
                    /* @__PURE__ */ jsx("span", { className: "text-muted-foreground/80", children: cat.desc })
                  ] })
                ] })
              ]
            },
        ...
        /* @__PURE__ */ jsx("div", { className: "hairline-t px-3 py-2 font-mono text-[10px] text-muted-foreground", children: "Layout saves automatically to this browser." })
      ]
    }
  ) });
}
...
function WidgetInfo({
  ...
  return /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute right-1.5 top-1.5 z-10 min-w-[160px] rounded-sm border border-border bg-panel/95 p-1.5 font-mono text-[10px] opacity-0 shadow-lg backdrop-blur-sm transition-opacity duration-100 group-hover:opacity-100", children: items.map((it) => /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-between gap-2 py-0.5", children: [
    /* @__PURE__ */ jsx("span", { className: "uppercase tracking-wider text-muted-foreground", children: it.label }),
    /* @__PURE__ */ jsxs("span", { className: "flex flex-col items-end leading-tight", children: [
      /* @__PURE__ */ jsx("span", { className: "tabular-nums text-foreground", children: it.value == null || !isFinite(it.value) ? "—" : (it.fmt ? it.fmt(it.value) : it.value.toFixed(2)) + (it.unit ? ` ${it.unit}` : "") }),
      /* @__PURE__ */ jsx("span", { className: "text-[9px] text-muted-foreground/80", children: it.channel || "—" })
    ] })
  ] }, it.label)) });
}
function CinemaPlayback({ parsed }) {
  const { cursorTick, setCursorTick, playing, setPlaying, speed, setSpeed, refLap } = useWorkbench();
  const [prefs] = useHudPrefs();
  const [settingsOpen, setSettingsOpen] = useState(false);
  const total = parsed.meta.numTicks;
  const currentLap = useMemo(() => {
    return parsed.laps.find((l) => cursorTick >= l.startTick && cursorTick <= l.endTick) ?? parsed.laps[0];
  ...
  const speedUnitLabel = prefs.speedUnit === "kmh" ? "KM/H" : prefs.speedUnit === "mph" ? "MPH" : "M/S";
  ...
  const jumpToLap = (which) => {
    ...
    if (here < 0) return;
    const target = which === "prev" ? parsed.laps[Math.max(0, here - 1)] : parsed.laps[Math.min(parsed.laps.length - 1, here + 1)];
    setCursorTick(target.startTick);
  };
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col bg-[radial-gradient(ellipse_at_center,_color-mix(in_oklab,var(--panel)_92%,var(--primary))_0%,var(--panel)_70%)]", children: [
    /* @__PURE__ */ jsxs("div", { className: "hairline-b flex items-center justify-between gap-3 px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "tabular-nums", children: fmtTime(lapTime) }),
        /* @__PURE__ */ jsxs(
          "button",
          {
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid min-h-0 flex-1 grid-cols-[1.2fr_1fr_1fr] gap-px overflow-hidden bg-border/40", children: [
      /* @__PURE__ */ jsxs("div", { className: "group relative flex items-center justify-center bg-panel", children: [
        /* @__PURE__ */ jsx(
          WidgetInfo,
          {
            items: [
        ...
        /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 200 200", className: "h-full w-full max-h-[280px] p-2", children: [
          /* @__PURE__ */ jsx(
            "path",
            {
              d: arcBgPath,
      ...
      /* @__PURE__ */ jsxs("div", { className: "group relative flex flex-col items-center justify-center gap-3 bg-panel p-3", children: [
        /* @__PURE__ */ jsx(
          WidgetInfo,
          {
            items: [
          ...
          /* @__PURE__ */ jsxs(
            "g",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("circle", { cx: 60, cy: 60, r: 8, fill: "var(--primary)" }),
                /* @__PURE__ */ jsx(
                  "line",
                  {
                    x1: 60,
        ...
        /* @__PURE__ */ jsx("div", { className: "flex w-full items-end justify-center gap-2", children: [
          { k: "T", v: throttle, color: "var(--ch-throttle)" },
          { k: "B", v: brake, color: "var(--ch-brake)" },
          { k: "C", v: clutch, color: "var(--ch-default)" }
        ].map((p) => /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
          /* @__PURE__ */ jsx("div", { className: "relative h-24 w-5 overflow-hidden rounded-sm bg-rail", children: /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: p.k }),
          /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] tabular-nums text-foreground", children: Math.round(p.v * 100) })
        ] }, p.k)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "group relative flex flex-col items-center justify-center gap-2 bg-panel p-3", children: [
        /* @__PURE__ */ jsx(
          WidgetInfo,
          {
            items: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 100 100", className: "h-32 w-32", children: [
          /* @__PURE__ */ jsx(
            "circle",
            {
              cx: 50,
          ...
          [0.5, 1, 1.5, 2].map((g) => /* @__PURE__ */ jsx(
            "circle",
            {
              cx: 50,
              cy: 50,
          ...
          /* @__PURE__ */ jsx("line", { x1: 50, y1: 2, x2: 50, y2: 98, stroke: "var(--border)", strokeWidth: 0.4 }),
          /* @__PURE__ */ jsx("line", { x1: 2, y1: 50, x2: 98, y2: 50, stroke: "var(--border)", strokeWidth: 0.4 }),
          /* @__PURE__ */ jsx(
            "circle",
            {
              cx: gDotX,
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid w-full grid-cols-2 gap-2 font-mono text-[10px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "LAT" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "LONG" }),
            /* @__PURE__ */ jsxs("span", { className: "tabular-nums", children: [
              longG >= 0 ? "+" : "",
              longG.toFixed(2),
              "g"
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "PCT" }),
            /* @__PURE__ */ jsxs("span", { className: "tabular-nums", children: [
              (lapPct * 100).toFixed(1),
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "FUEL" }),
            /* @__PURE__ */ jsx("span", { className: "tabular-nums", children: fuelL != null ? `${fuelL.toFixed(1)}L` : "—" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 100 100", className: "h-12 w-12", children: [
          /* @__PURE__ */ jsx(
            "circle",
            {
              cx: 50,
    ...
    /* @__PURE__ */ jsxs("div", { className: "hairline-t flex items-center gap-2 bg-panel px-3 py-2", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "font-mono text-[10px] tabular-nums text-muted-foreground", children: [
    ...
    settingsOpen && /* @__PURE__ */ jsx(HudSettings, { parsed, onClose: () => setSettingsOpen(false) })
  ] });
}
export {
  CinemaPlayback
