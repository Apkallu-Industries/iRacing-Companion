...
const VEHICLE_PROFILES = {
  LMGT3: {
    ...
    wheelbase: 2.78, // average GT3 wheelbase (m)
  ...
  GTP: {
    ...
    physicsProfileVersion: "2.0.2",
    wheelbase: 3.0, // GTP / LMDh class wheelbase (m)
    steeringRatio: 12.0,
  ...
  NASCAR: {
    ...
    physicsProfileVersion: "2.0.2",
    wheelbase: 2.8, // Cup/Xfinity wheelbase (m)
    steeringRatio: 16.0,
  ...
  Rallycross: {
    ...
    wheelbase: 2.5, // Short dirt wheelbase
...
function resolveVehicleProfile(carName) {
  ...
  if (
    name.includes("gt3") ||
    name.includes("lmgt3") ||
    name.includes("porsche 911 gt3") ||
    name.includes("audi r8 gt3") ||
    name.includes("m4 gt3") ||
    name.includes("amg gt3")
  ) {
  ...
  if (
    name.includes("gtp") ||
    name.includes("lmdh") ||
    name.includes("bmw m hybrid") ||
    name.includes("porsche 963") ||
    name.includes("cadillac v-series")
  ) {
