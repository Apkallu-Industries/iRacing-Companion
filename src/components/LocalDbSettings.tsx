        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-xs leading-relaxed text-muted-foreground">
              ...
              <div className="space-y-1">
                ...
                <p>
                  Click "Test Connection" below. This will ping the local MongoDB instance and
                  initialize required schemas and indexes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-4 border-t border-border/40">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Telemetry binary files (<code className="font-mono">.ibt</code> and{" "}
              <code className="font-mono">.pwlap</code>) are saved in your browser's local cache.
              You can empty this cache to free up disk space.
            </p>
            <Button
              type="button"
              variant="destructive"
