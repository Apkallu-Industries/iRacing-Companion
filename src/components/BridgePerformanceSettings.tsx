    ...
    <div className="space-y-3 text-xs">
      <div className="grid gap-2 sm:grid-cols-2">
        ...
        >
          ...
          <div className="mt-1 text-[11px] text-zinc-400">Best for weaker clients and consistent delivery.</div>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <div className="mt-1 text-[11px] text-zinc-400">Smoother visuals with adaptive fallback to 30Hz.</div>
        </button>
      </div>
      ...
      <div className="rounded-sm border border-zinc-800 bg-zinc-900/50 p-2 text-[11px] text-zinc-400">
        ...
        {" · "}
        Recommended: <span className="text-zinc-200">{recommended === "stable30" ? "Stable 30Hz" : "Balanced 60Hz"}</span>
        <button
          type="button"
