          ...
          <div className="flex flex-col justify-between border-r border-[#1C2430]/60 pr-3">
            ...
            <div className="grid grid-cols-2 gap-2 my-2">
              ...
              >
                ...
                <span className="text-[8px] text-white mt-1 tabular-nums">
                  {flBrakePress.toFixed(1)} Bar
                </span>
              </div>
          ...
          <div className="flex flex-col justify-between pl-1">
            ...
            <div className="flex-1 flex flex-col justify-center gap-1.5 my-2.5">
              ...
              <div className="h-10 bg-[#0B0F14] border border-[#1C2430] rounded-sm p-1.5 relative overflow-hidden flex flex-col justify-center">
                ...
                <div
                  className="absolute top-0 bottom-0 border-l border-dashed border-[#FFB800] z-10"
                  style={{ left: `${thresholdLimit}%` }}
                  title="Target threshold line"
                >
                  <span className="absolute top-0.5 left-1 text-[7px] text-[#FFB800] font-black tracking-widest bg-[#05070A] px-0.5 rounded">
                    THR: {thresholdLimit}%
                  </span>
                </div>
              </div>
