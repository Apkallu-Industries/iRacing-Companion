...
export const OBJECTIVE_CONFIGS: Record<SessionObjectiveMode, ObjectiveConstraints> = {
  QUALIFYING_ATTACK: {
    ...
    wheelspinSensitivityCoeff: 0.7, // highly sensitive, warn about minor wheel slips
    ...
    aiNarrativeTone:
      "aggressive, performance-hyperfocused, emphasizing peak tire grip vectors and deceleration precision",
  },
  RACE_STINT: {
    modeName: "Standard Race Stint",
    wheelspinSensitivityCoeff: 1.0,
    brakeLockupThreshold: 0.8,
    ersDeployWeightFactor: 1.0,
    fuelTargetPerLapL: 3.65,
    aiNarrativeTone:
      "restrained, structural, focusing on carcass thermal conservation and pace variance consistency",
  },
  FUEL_SAVE: {
    ...
    aiNarrativeTone:
      "conservation-focused, calculating exact lift-and-coast points and hybrid efficiency decays",
  },
  SAFETY_CAR: {
    modeName: "Safety Car Pace & Heat Conservation",
    wheelspinSensitivityCoeff: 1.5,
    brakeLockupThreshold: 0.6,
    ersDeployWeightFactor: 0.5,
    fuelTargetPerLapL: 1.2,
    aiNarrativeTone:
      "thermal-focused, advising on brake drag surface sweeps to preserve tire carcass temperatures",
  },
  OUTLAP: {
    modeName: "Outlap Surface Scuffing",
    wheelspinSensitivityCoeff: 1.2,
    brakeLockupThreshold: 0.7,
    ersDeployWeightFactor: 0.9,
    fuelTargetPerLapL: 3.8,
    aiNarrativeTone:
      "surface scuffing focus, highlighting tire pressure growth thresholds and brake drum heats",
  },
  TIRE_WARMUP: {
    modeName: "Carcass Core Thermal Induction",
    wheelspinSensitivityCoeff: 0.9,
    brakeLockupThreshold: 0.75,
    ersDeployWeightFactor: 0.95,
    fuelTargetPerLapL: 4.0,
    aiNarrativeTone:
      "thermal-building focus, analyzing steering load sweeps to accelerate carcass expansion",
  },
  DEFENSIVE_TRAFFIC: {
    modeName: "Defensive Traffic Positioning",
    wheelspinSensitivityCoeff: 0.85,
    brakeLockupThreshold: 0.78,
    ersDeployWeightFactor: 1.1, // high deploy prioritization to defend straightaways
    fuelTargetPerLapL: 3.5,
    aiNarrativeTone:
      "defensive, highlighting aerodynamic wash boundaries and cooling degradation velocities",
  },
};
