...
export interface InstabilityPrediction {
  ...
  primaryTriggerFactor: "STEERING_CORRECTION" | "YAW_ACCELERATION_SPIKE" | "AERO_PLATFORM_STALL" | "ERS_TORQUE_OVERLOAD" | "THROTTLE_OSCILLATION" | "NONE";
...
export function predictNextTickInstability(
  ...
  if (Math.abs(yawAccel) > 1.5) { // yaw rate changing faster than 85 deg/sec^2
