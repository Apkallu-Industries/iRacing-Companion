...
2. **Deterministic Replayability**: Given identical raw telemetry, a specific ontology kernel version, a heuristics engine pack, and an engineering personality, the platform _must_ reproduce identical events, causal nodes, and engineering recommendations.
...
- **Subsystem Reuse**: If a subsystem already models a physical concept, developers _must_ extend it rather than writing a duplicate file.
