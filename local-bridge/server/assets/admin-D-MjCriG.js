...
const adminListUsers = createServerFn({
  ...
  .handler(createSsrRpc("35cf6cc28f61c798a570ec39672552de8ed250f60706565e25b34a66f0c5b240"));
...
const getMyRole = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .handler(createSsrRpc("e2507865c01468809aa67f84f243facd748d53ebf53d1a04baa0f86f26aed510"));
const ROLE_CONFIG = {
  admin: {
    label: "Admin",
...
function RoleSelect({ userId, current, selfId, onUpdate }) {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsx("select", {
        ...
        title: isSelf ? "You cannot change your own role" : void 0,
        children: roles.map((r) =>
          /* @__PURE__ */ jsx("option", { value: r, children: ROLE_CONFIG[r].label }, r),
        ),
      }),
      busy
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx("button", {
                ...
                className: `px-6 py-3 border-b-2 font-semibold transition-all cursor-pointer ${adminTab === "users" ? "border-racing-red text-foreground bg-panel" : "border-transparent text-muted-foreground hover:text-foreground"}`,
                children: "User Management",
              }),
              /* @__PURE__ */ jsx("button", {
                onClick: () => setAdminTab("keygen"),
                className: `px-6 py-3 border-b-2 font-semibold transition-all cursor-pointer ${adminTab === "keygen" ? "border-racing-red text-foreground bg-panel" : "border-transparent text-muted-foreground hover:text-foreground"}`,
          ...
          adminTab === "users"
            ? /* @__PURE__ */ jsxs(Fragment, {
                children: [
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(StatCard, {
                        label: "Total Users",
                        value: users.length,
                        icon: /* @__PURE__ */ jsx(Users, { className: "h-3.5 w-3.5" }),
                      }),
                      /* @__PURE__ */ jsx(StatCard, {
                        label: "Admins",
                        value: adminCount,
                        icon: /* @__PURE__ */ jsx(Shield, {
                          className: "h-3.5 w-3.5 text-racing-red",
                        }),
                      }),
                      /* @__PURE__ */ jsx(StatCard, {
                        label: "Beta Testers",
                        ...
                        icon: /* @__PURE__ */ jsx(Star, {
                          className: "h-3.5 w-3.5 text-racing-cyan",
                        }),
                      }),
                      /* @__PURE__ */ jsx(StatCard, {
                  ...
                  /* @__PURE__ */ jsx("div", {
                    className: "rounded-lg border border-racing-cyan/20 bg-racing-cyan/5 px-5 py-4",
                    children: /* @__PURE__ */ jsxs("div", {
                      className: "flex items-start gap-3",
                      children: [
                        /* @__PURE__ */ jsx(Star, {
                          className: "h-4 w-4 text-racing-cyan mt-0.5 shrink-0",
                        }),
                        /* @__PURE__ */ jsxs("div", {
                          className: "text-sm",
                          children: [
                                  ...
                                  /* @__PURE__ */ jsx("thead", {
                                    children: /* @__PURE__ */ jsxs("tr", {
                                      ...
                                      children: [
                                        ...
                                        /* @__PURE__ */ jsx("th", {
                                          className: "px-4 py-3 text-left hidden sm:table-cell",
                                          children: /* @__PURE__ */ jsxs("div", {
                                              ...
                                              "tr",
                                              {
                                                ...
                                                children: [
                                                  ...
                                                  /* @__PURE__ */ jsx("td", {
                                                    ...
                                                    children: fmtDate(u.last_sign_in_at),
                                                  }),
                                                  /* @__PURE__ */ jsx("td", {
                                                    className:
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          /* @__PURE__ */ jsx(Key, {
                            className: "h-4 w-4 text-racing-red animate-pulse",
                          }),
                          /* @__PURE__ */ jsx("h2", {
                      ...
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("p", {
                            className: "text-[9px] text-muted-foreground leading-normal uppercase",
                            children: [
