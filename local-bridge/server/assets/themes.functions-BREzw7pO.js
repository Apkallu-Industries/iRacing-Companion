...
const listSharedThemes = createServerFn({
  ...
  .handler(listSharedThemes_createServerFn_handler, async ({ context }) => {
...
const publishTheme = createServerFn({
  ...
  .handler(publishTheme_createServerFn_handler, async ({ data, context }) => {
...
const deleteSharedTheme = createServerFn({
  ...
  .handler(deleteSharedTheme_createServerFn_handler, async ({ data, context }) => {
    const { supabase } = context;
