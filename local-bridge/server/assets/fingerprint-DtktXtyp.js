...
import {
  ...
  c as clearFingerprint,
} from "./compute-GEPYhqPD.js";
import { b as upsertFingerprint } from "./fingerprint.functions-64RahZZ8.js";
import { J as useAuth, K as useTelemetry } from "./router-D8VllJ-f.js";
...
function trendIcon(t) {
  if (t === "improving")
    return /* @__PURE__ */ jsx(TrendingUp, { className: "h-3 w-3 text-emerald-400" });
  if (t === "regressing")
    return /* @__PURE__ */ jsx(TrendingDown, { className: "h-3 w-3 text-rose-400" });
  if (t === "flat")
    return /* @__PURE__ */ jsx(Minus, { className: "h-3 w-3 text-muted-foreground" });
    ...
    children: [
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", {
            className: `font-mono text-2xl tabular-nums ${scoreColor(c.score)}`,
            children: c.score.toFixed(0),
          }),
        ],
      }),
      /* @__PURE__ */ jsx("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsx("div", {
                className: "text-foreground tabular-nums",
                children: c.improvement != null ? `${(c.improvement * 100).toFixed(1)}%` : "—",
              }),
            ],
          }),
          /* @__PURE__ */ jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsx("div", {
                className: "text-foreground tabular-nums",
                children: c.sigma != null ? `${c.sigma.toFixed(2)}s` : "—",
              }),
            ],
          }),
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", {
                className: "text-foreground tabular-nums",
                children: formatLapTime(c.bestPair.bestEverS),
              }),
            ],
          }),
        ],
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [c.bestPair.track, " · ", c.bestPair.car],
      }),
    ],
  });
}
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("span", {
                            children: [classSummaries.length, " classes"],
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsx("div", {
                        className: "grid grid-cols-1 gap-2 p-3 sm:grid-cols-2 lg:grid-cols-3",
                        children: classSummaries.map((c) =>
                          /* @__PURE__ */ jsx(ClassScoreCard, { c }, c.cls),
                        ),
                      }),
                      /* @__PURE__ */ jsx("div", {
                        className:
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxs("span", { children: [sortedPairs.length, " pairs"] }),
                      ],
                    }),
                    /* @__PURE__ */ jsx("div", {
                              ...
                              return /* @__PURE__ */ jsxs(
                                "tr",
                                {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsx("td", {
                                      className: "px-2 py-1 text-right tabular-nums",
                                      children: formatLapTime(p.bestEverS),
                                    }),
                                    /* @__PURE__ */ jsx("td", {
                                      className:
                                        "px-2 py-1 text-right tabular-nums text-muted-foreground",
                                      children: formatLapTime(p.medianBestS),
                                    }),
                                    /* @__PURE__ */ jsx("td", {
                                      className:
                                        "px-2 py-1 text-right tabular-nums text-muted-foreground",
                                      children: p.bestStdevS.toFixed(3),
                                    }),
                                    /* @__PURE__ */ jsx("td", {
...
export { FingerprintPage as component };
