                    ...
                    /* @__PURE__ */ jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("span", {
                            className: `font-black shrink-0 ${log.type === "SYSTEM" ? "text-[#3B82F6]" : log.type === "STINT_ANALYSIS" ? "text-[#8B5CF6]" : log.type === "OBSERVATION" ? "text-[#FFB800]" : log.type === "RECOMMENDATION" ? "text-[#00D17F]" : "text-[#FF4D4D]"}`,
                            children: [log.type, ":"],
                          }),
                          /* @__PURE__ */ jsx("span", {
              ...
              /* @__PURE__ */ jsxs("form", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("button", {
                    ...
                    children: [/* @__PURE__ */ jsx(Send, { className: "h-3 w-3" }), "SEND"],
                  }),
                ],
              }),
            ],
                                  ...
                                  /* @__PURE__ */ jsxs("td", {
                                    ...
                                    children: [
                                      ...
                                      item.flDelta &&
                                        ...
                                        item.flDelta !== "0" &&
                                        /* @__PURE__ */ jsxs("div", {
                                          className: `text-[8px] mt-0.5 ${statusColor(item.flStatus)}`,
                                          children: ["(", item.flDelta, ")"],
                                        }),
                                    ],
                                  }),
                                  /* @__PURE__ */ jsxs("td", {
                                    ...
                                    children: [
                                      ...
                                      item.frDelta &&
                                        ...
                                        item.frDelta !== "0" &&
                                        /* @__PURE__ */ jsxs("div", {
                                          className: `text-[8px] mt-0.5 ${statusColor(item.frStatus)}`,
                                          children: ["(", item.frDelta, ")"],
                                        }),
                                    ],
                                  }),
                                  /* @__PURE__ */ jsxs("td", {
                                    ...
                                    children: [
                                      ...
                                      item.rlDelta &&
                                        ...
                                        item.rlDelta !== "0" &&
                                        /* @__PURE__ */ jsxs("div", {
                                          className: `text-[8px] mt-0.5 ${statusColor(item.rlStatus)}`,
                                          children: ["(", item.rlDelta, ")"],
                                        }),
                                    ],
                                  }),
                                  /* @__PURE__ */ jsxs("td", {
                                    ...
                                    children: [
                                      ...
                                      item.rrDelta &&
                                        ...
                                        item.rrDelta !== "0" &&
                                        /* @__PURE__ */ jsxs("div", {
                                          className: `text-[8px] mt-0.5 ${statusColor(item.rrStatus)}`,
                                          children: ["(", item.rrDelta, ")"],
                                        }),
                                    ],
                                  }),
                                ],
...
export { AIEngineerTerminal as component };
