...
const upsertMyGearRatios = createServerFn({
  ...
  .handler(upsertMyGearRatios_createServerFn_handler, async ({ data, context }) => {
...
const getMyGearRatios = createServerFn({
  ...
  .handler(getMyGearRatios_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
...
const publishMyGearRatios = createServerFn({
  ...
  .handler(publishMyGearRatios_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
...
const listCommunityGearRatios = createServerFn({
  ...
  .handler(listCommunityGearRatios_createServerFn_handler, async ({ data, context }) => {
...
const upsertMyChannelLayout = createServerFn({
  ...
  .handler(upsertMyChannelLayout_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
...
const getMyChannelLayout = createServerFn({
  ...
  .handler(getMyChannelLayout_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
    const { data: row } = await supabase
      .from("shared_channel_layouts")
...
const publishMyChannelLayout = createServerFn({
  ...
  .handler(publishMyChannelLayout_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
    const { error } = await supabase
      .from("shared_channel_layouts")
      .update({
...
const listCommunityChannelLayouts = createServerFn({
  ...
  .middleware([requireSupabaseAuth])
  .handler(listCommunityChannelLayouts_createServerFn_handler, async ({ context }) => {
    const { supabase } = context;
...
const upsertMyCarClass = createServerFn({
  ...
  .handler(upsertMyCarClass_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
...
const listCommunityCarClasses = createServerFn({
  ...
  .handler(listCommunityCarClasses_createServerFn_handler, async ({ data, context }) => {
    const { supabase } = context;
    let q = supabase
...
const voteCommunityItem = createServerFn({
  ...
  .handler(voteCommunityItem_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
    const { data: existing } = await supabase
...
const syncDesktopLaps = createServerFn({
  ...
  .handler(syncDesktopLaps_createServerFn_handler, async ({ data, context }) => {
    const { supabase, userId } = context;
