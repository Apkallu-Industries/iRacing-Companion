...
function StatusIcon({ status }) {
  ...
  if (status === "initializing")
    return /* @__PURE__ */ jsx(Loader2, { className: `${size} animate-spin`, style: { color } });
  if (status === "active")
    return /* @__PURE__ */ jsx(CheckCircle, { className: size, style: { color } });
  if (status === "degraded")
    return /* @__PURE__ */ jsx(AlertTriangle, { className: size, style: { color } });
  return /* @__PURE__ */ jsx(XCircle, { className: size, style: { color } });
}
function ServiceRow({ icon: Icon, name, service, isLast = false }) {
...
function RuntimeStatusMatrix({ onReady }) {
  ...
  const overallStatus = !status.settled
    ? "initializing"
    : status.ready
      ? "active"
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("span", {
                            ...
                            children: String(i).padStart(3, "0"),
                          }),
                          /* @__PURE__ */ jsx("span", {
                            style: { color },
...
export { RuntimePage as component };
