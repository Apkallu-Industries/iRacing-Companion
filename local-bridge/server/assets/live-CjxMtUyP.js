...
import {
  J as useAuth,
  n as dispatchLiveCoach,
  M as useTheme,
  o as getBridgePerformanceMode,
  C as supabase,
  N as useWorkbench,
  l as dispatchAdvisorCall,
  G as upsertMyChannelLayout,
  v as publishMyChannelLayout,
  s as listCommunityChannelLayouts,
  O as voteCommunityItem,
  H as upsertMyGearRatios,
  w as publishMyGearRatios,
  t as listCommunityGearRatios,
  K as useTelemetry,
  L as LAYOUT_PROFILES,
  W as WORKSPACES,
  P as PRESETS,
  D as DARK_THEME,
...
import {
  g as getFingerprintForPair,
  a as getLastSessionForPair,
  b as upsertFingerprint,
} from "./fingerprint.functions-64RahZZ8.js";
import { z } from "zod";
import { toast } from "sonner";
import {
  r as recordTelemetrySessionMeta,
  b as buildRegistry,
  c as compileMathExpression,
  e as evaluateCompiledMathExpression,
  D as DEFAULT_CHANNEL_KEYS,
  l as loadChannelPrefs,
  s as saveChannelPrefs,
  M as MiniTrace,
  a as computeHistogram,
  S as STATIC_CHANNELS$1,
  T as TelemetryEventTimeline,
} from "./histogramUtils-BD74-wnA.js";
import {
  l as loadFingerprint,
  a as selectLapfiles,
  p as parseRaw,
  b as buildFingerprint,
  s as saveFingerprint,
} from "./compute-GEPYhqPD.js";
...
import { s as speakText } from "./tts.functions-CbCKt0n5.js";
import { W as WORKSPACE_PRESETS, T as TELEMETRY_INSTRUMENTS } from "./registry-CA38QAmy.js";
...
const getPersonalBest = createServerFn({
  ...
  .handler(createSsrRpc("84a6f6d08f7994fe77af22dcb19c019c2ed58ade8761ccfd8c8af0f6dd7a5a5f"));
...
function LiveCoach({ t }) {
                      ...
                      children: [
                        ...
                        lastConfidence != null &&
                          ...
                          /* @__PURE__ */ jsxs("span", {
                            ...
                            children: ["Confidence: ", lastConfidence, "%"],
                          }),
                        pb &&
                          call &&
                          /* @__PURE__ */ jsxs("span", {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: `bg-panel-2 ring-1 ${call ? style.ring : "ring-white/5"} rounded-lg p-4`,
    children: [
      /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx(PbCell, {
            label: "PB",
            value: fmtLap$1(pb?.lapTimeS ?? null),
            highlight: true,
          }),
          /* @__PURE__ */ jsx(PbCell, {
            label: "S1 BEST",
            value: pb?.s1S != null ? pb.s1S.toFixed(3) : "—",
          }),
          /* @__PURE__ */ jsx(PbCell, {
            label: "S2 BEST",
            value: sectorBests?.s2 != null ? sectorBests.s2.toFixed(3) : "—",
          }),
          /* @__PURE__ */ jsx(PbCell, {
            label: "LAPS LOGGED",
            value: `${validLapsThisSession} / ${pbCount}`,
          }),
        ],
      }),
      !call &&
      ...
      call &&
        !loading &&
        /* @__PURE__ */ jsxs("div", {
          className: `rounded-md p-3 ${style.bg} ring-1 ${style.ring}`,
          children: [
            /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsxs("span", {
                  ...
                  children: [/* @__PURE__ */ jsx(ToneIcon, { className: "h-3 w-3" }), style.label],
                }),
                lastConfidence != null &&
                  /* @__PURE__ */ jsxs("span", {
                    className: "font-mono text-[9px] text-muted-foreground",
                    title: "Rules-engine confidence",
                    children: [lastConfidence, "%"],
                  }),
                pb &&
                  /* @__PURE__ */ jsxs("span", {
...
function PbCell({ label, value, highlight }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", {
        className: `tabular-nums ${highlight ? "text-racing-green" : "text-foreground"}`,
        children: value,
      }),
    ],
  });
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx(RefCell, {
            label: "This best",
            value: fmtLap(liveBest),
            highlight: true,
          }),
          /* @__PURE__ */ jsx(RefCell, {
            label: "All-time PB",
...
function RefCell({ label, value, delta, sub, highlight, link }) {
  const dColor =
    delta == null
  ...
  const inner = /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", {
        className: `tabular-nums ${highlight ? "text-racing-cyan" : "text-foreground"}`,
        children: value,
      }),
      /* @__PURE__ */ jsx("div", {
        className: `text-[10px] tabular-nums ${dColor}`,
        children: dStr || (sub ?? " "),
      }),
      dStr &&
        sub &&
...
const startBridge = createServerFn({
  ...
  .handler(createSsrRpc("44ccc16895fc9e7ce2624636ebfdb09af87f537ec0f50a6c81242686434b920a"));
createServerFn({
  method: "POST",
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsx(Wifi, {
                className: `h-4 w-4 ${step3 ? "text-emerald-400" : "text-racing-orange"}`,
              }),
              /* @__PURE__ */ jsx("h2", {
                className:
          ...
          /* @__PURE__ */ jsx("button", {
            ...
            children: /* @__PURE__ */ jsx(RefreshCw, {
              className: `h-3.5 w-3.5 ${bridge.checking ? "animate-spin" : ""}`,
            }),
          }),
        ],
      }),
        ...
        children: [
          ...
          sampleCount > 0 &&
            ...
            /* @__PURE__ */ jsxs("button", {
              ...
              title: "Discard",
              children: [/* @__PURE__ */ jsx(Trash2, { className: "h-3.5 w-3.5" }), "Discard"],
            }),
        ],
      }),
      !user &&
...
function AdvisorButton({ t }) {
  ...
  const ask = async (mode) => {
    ...
    try {
      ...
      const pbS = validLaps.reduce((m, l) => (m == null || l.lapTimeS < m ? l.lapTimeS : m), null);
  ...
  const segBtn = (active) =>
    `px-2.5 py-1 text-[10px] uppercase tracking-wider rounded ring-1 transition ${active ? "bg-racing-orange/20 text-racing-orange ring-racing-orange/40" : "bg-muted/40 text-muted-foreground ring-white/5 hover:text-foreground"}`;
  return /* @__PURE__ */ jsxs("div", {
    className: "bg-panel-2 ring-1 ring-white/5 rounded-lg p-4",
    children: [
      /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx("button", {
                    className: segBtn(trackType === "road"),
                    onClick: () => setTrackType("road"),
                    children: "Road",
                  }),
                  /* @__PURE__ */ jsx("button", {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsx("button", {
                    className: segBtn(cornerBias === "left"),
                    onClick: () => setCornerBias("left"),
                    children: "Left",
                  }),
                  /* @__PURE__ */ jsx("button", {
          ...
          /* @__PURE__ */ jsxs("span", {
            children: [
              ...
              symptoms.length > 0 &&
                /* @__PURE__ */ jsxs("span", {
                  className: "text-racing-orange",
                  children: ["· ", symptoms.length, " selected"],
                }),
            ],
          }),
          wizardOpen
      ...
      wizardOpen &&
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ["balance", "brakes", "tyres", "ride"].map((group) =>
              /* @__PURE__ */ jsxs(
                "div",
                {
                  children: [
                    ...
                    /* @__PURE__ */ jsx("div", {
                      ...
                      children: SYMPTOM_OPTIONS.filter((s) => s.group === group).map((s) => {
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("ul", {
              ...
              children: result.tips.map((tip, i) =>
                /* @__PURE__ */ jsxs(
                  "li",
                  {
                    className: `rounded-md border px-2.5 py-2 ${prioStyles[tip.priority]}`,
                    children: [
                      /* @__PURE__ */ jsxs("div", {
...
function CommunityBrowser({ open, title, loader, onImport, onVote, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", {
    ...
    children: /* @__PURE__ */ jsxs("div", {
      className: "w-full max-w-xl rounded-t-sm border border-zinc-800 bg-zinc-950 sm:rounded-sm",
      children: [
        /* @__PURE__ */ jsxs("div", {
...
function Row({ row, onImport, onVote }) {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              /* @__PURE__ */ jsxs("span", {
                ...
                children: [visibleChannels.length, "/", registry.length],
              }),
              /* @__PURE__ */ jsx("button", {
                type: "button",
                        ...
                        ? /* @__PURE__ */ jsxs("span", {
                            ...
                            children: [
                              /* @__PURE__ */ jsx("div", {
                                ...
                                children: /* @__PURE__ */ jsx(MiniTrace, {
                                  values: historyRef.current[c.key] ?? [],
                                  color: c.color,
                                }),
                              }),
                              /* @__PURE__ */ jsx("span", {
...
function EditPanel({
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("ul", {
        className: "divide-y divide-border",
        children: visibleKeys.map((key, idx) => {
                                  ...
                                  onChange: (e) =>
                                    updateExpression(m.id, {
                                      speechAlertThreshold:
                                        e.target.value === "" ? void 0 : parseFloat(e.target.value),
                                    }),
                                  className:
                                    "w-full rounded-sm border border-border-strong bg-muted px-1.5 py-1 text-[10px] text-foreground",
                                  placeholder: "e.g. 1.2",
        ...
        children: [
          /* @__PURE__ */ jsxs("div", {
            children: [
              ...
              /* @__PURE__ */ jsx("div", {
                className: `text-lg tabular-nums ${toneClass[advice.action.tone]}`,
                children: advice.action.label,
              }),
              /* @__PURE__ */ jsx("div", {
                className: "text-[9px] text-muted-foreground",
                children: advice.action.detail,
              }),
            ],
          }),
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                className: "text-[9px] text-muted-foreground",
                children: ["warn ", Math.round(advice.warn), " · red ", Math.round(advice.red)],
              }),
            ],
          }),
        ],
        ...
        children: [
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", {
                ...
                children: advice.rpmAfterUp ? `${Math.round(advice.rpmAfterUp)} rpm` : "—",
              }),
              /* @__PURE__ */ jsxs("div", {
                className: "text-[9px] text-muted-foreground",
                children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", {
                className: "tabular-nums text-foreground",
                children: advice.rpmAfterDown ? `${Math.round(advice.rpmAfterDown)} rpm` : "—",
              }),
              /* @__PURE__ */ jsxs("div", {
                className: "text-[9px] text-muted-foreground",
                children: [
                ...
                return /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("span", {
                        className: "text-muted-foreground",
                        children: ["G", g.from, "→G", g.to],
                      }),
                      /* @__PURE__ */ jsxs("span", {
                        className: "text-foreground",
                        children: [g.pct.toFixed(1), "%"],
                      }),
                      /* @__PURE__ */ jsx("span", {
                        className: `uppercase text-[9px] ${tagColor}`,
                        children: tag,
                      }),
                    ],
                  },
          ...
          /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", {
                  className: "text-foreground",
                  children: diagnostics.connectionStatus,
                }),
              ],
            }),
          }),
...
function HistogramWidget({ samples, selectedChannelKey = "throttle" }) {
...
function ScatterWidget({ samples, xChannelKey = "throttle", yChannelKey = "brake" }) {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("select", {
                ...
                children: CHANNEL_KEYS.map((k) =>
                  /* @__PURE__ */ jsx(
                    "option",
                    { value: k, children: STATIC_CHANNELS$1.find((c) => c.key === k)?.label || k },
                    k,
                  ),
                ),
              }),
          ...
          children: [
            /* @__PURE__ */ jsxs("span", {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", {
                  className: "text-foreground",
                  children: metrics.correlation.toFixed(2),
                }),
              ],
            }),
            /* @__PURE__ */ jsxs("span", {
...
function HeaderCell({ label, onSort, active, order }) {
...
function Cell({ value, unit, status }) {
  const textColor =
    status === "in-progress"
      ? "text-emerald-400"
      : status === "complete"
  ...
  return /* @__PURE__ */ jsx("td", {
    className: `px-2 py-1 text-right tabular-nums ${textColor}`,
    children:
      value != null
        ? /* @__PURE__ */ jsxs(Fragment, {
            children: [
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("div", {
                      className: "h-[240px]",
                      children: /* @__PURE__ */ jsx(ScatterWidget, {
                        samples,
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("div", {
                      className: "h-[240px]",
                      children: /* @__PURE__ */ jsx(HistogramWidget, {
                        samples,
          ...
          activeTab === "histogram" &&
            /* @__PURE__ */ jsx(HistogramWidget, { samples, selectedChannelKey: "throttle" }),
          activeTab === "scatter" &&
            /* @__PURE__ */ jsx(ScatterWidget, {
              samples,
              xChannelKey: "throttle",
              yChannelKey: "brake",
            }),
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", {
            className: `font-mono text-[18px] font-bold tabular-nums ${deltaColor}`,
            children: deltaStr,
          }),
        ],
      }),
...
function F1SectorTable({ t }) {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", {
        className: "space-y-1",
        children: rows.map(({ label, key, idx }) => {
        ...
        children: [
          corners.map(({ key, label, gridPos }) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                className: `${gridPos} text-center`,
                children: [
                  /* @__PURE__ */ jsx("div", {
                    className: `font-mono text-[22px] font-bold tabular-nums leading-none ${color}`,
                    children: temp,
                  }),
                  /* @__PURE__ */ jsx("div", {
          ...
          /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsx(CarSilhouette, {}),
          }),
        ],
      }),
    ],
...
function Stat({ label, value, valueColor = "text-foreground" }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", {
        className: `font-mono text-[12px] font-bold tabular-nums ${valueColor}`,
        children: value,
      }),
    ],
  });
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("tr", {
                  children: [
                    ...
                    /* @__PURE__ */ jsx("td", {
                      className: `px-2 py-1.5 text-right tabular-nums ${deltaColor(deltaS1)}`,
                      children: fmtDelta(deltaS1),
                    }),
                    /* @__PURE__ */ jsx("td", {
                      className: `px-2 py-1.5 text-right tabular-nums ${deltaColor(deltaS2)}`,
                      children: fmtDelta(deltaS2),
                    }),
                    /* @__PURE__ */ jsx("td", {
                      className: `px-2 py-1.5 text-right tabular-nums ${deltaColor(deltaS3)}`,
                      children: fmtDelta(deltaS3),
                    }),
                    /* @__PURE__ */ jsx("td", {
                      className: `px-2 py-1.5 text-right tabular-nums font-bold ${totalDelta < 0 ? "text-emerald-400" : "text-rose-400"}`,
                      children: fmtDelta(totalDelta),
                    }),
                  ],
                }),
              ],
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", {
                    className: "text-xs font-bold text-[#FFB800]",
                    children: "L1",
                  }),
                ],
              }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsxs("span", {
                    className: "text-[10px] text-[#7A828C]",
                    children: ["/ ", numDrivers],
                  }),
                ],
              }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  "3:24",
                  /* @__PURE__ */ jsx("span", {
                    className: "text-[10px] text-[#00e676]/70",
                    children: ":52",
                  }),
                ],
              }),
                ...
                children: competitors.map((comp) => {
                  ...
                  return /* @__PURE__ */ jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", {
                          className: `col-span-1 font-bold ${posColor} flex items-center gap-1`,
                          children: [
                            isTracked &&
                              /* @__PURE__ */ jsx("span", {
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                    ...
                    children: /* @__PURE__ */ jsxs("g", {
                      ...
                      children: [
                        ...
                        competitors.map((comp) => {
                          ...
                          if (
                            trackDef.pitSpline &&
                            trackDef.exitPct !== void 0 &&
                            trackDef.mergePct !== void 0
                          ) {
                            const isInsidePit =
                              trackDef.exitPct > trackDef.mergePct
                  ...
                  /* @__PURE__ */ jsx("div", {
                    ...
                    children: trackDef.sectors.map((sec) =>
                      /* @__PURE__ */ jsxs(
                        "span",
                        {
                          className: "font-bold",
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", {
                        className: "text-[7.5px] text-[#7A828C]",
                        children: "THR",
                      }),
                    ],
                  }),
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("span", {
                        ...
                        children: Math.round(speed * 0.621371),
                      }),
                      /* @__PURE__ */ jsx("span", {
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("span", { children: ["S2: ", s2Time] }),
                      /* @__PURE__ */ jsxs("span", { children: ["S3: ", s3Time] }),
                    ],
                  }),
                ],
              }),
  ...
  return /* @__PURE__ */ jsxs("main", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(RpmBar, {
        rpm: t.rpm,
        warn: t.rpmShiftWarn,
        red: t.rpmShiftRedline,
        max: t.rpmMax,
      }),
      isRaceCommand
        ? /* @__PURE__ */ jsx(RaceCommandLayout, { t, samples })
        : isF1Layout
          ? /* ═══════════════ F1 LAYOUT ═══════════════ */
            /* @__PURE__ */ jsxs(Fragment, {
              children: [
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("section", {
                      className: "col-span-3 flex flex-col overflow-hidden border-r border-border",
                      children: [
                        /* @__PURE__ */ jsxs("div", {
                          className:
                        ...
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx(F1QuickStats, { t }),
                        }),
                      ],
                    }),
                    /* @__PURE__ */ jsxs("section", {
                      className: "col-span-6 flex flex-col overflow-hidden border-r border-border",
                      children: [
                        /* @__PURE__ */ jsxs("div", {
                          className:
                          ...
                          children: [
                            /* @__PURE__ */ jsx(PanelHeader, {
                              title: "Time Trace",
                              right: cursor
                                ? `cursor t=${(cursor.sample.t / 1e3).toFixed(2)}s`
                                : "Last 30s · 60Hz",
                            }),
                            /* @__PURE__ */ jsx(FilterControls, {
                              mode: smoothing,
                              window: smoothWindow,
                              onMode: setSmoothing,
                        ...
                        /* @__PURE__ */ jsx("div", {
                          className: "flex-1 min-h-0 overflow-hidden",
                          children: /* @__PURE__ */ jsx(TraceStack, {
                            samples,
                            smoothing,
                            smoothWindow,
                    ...
                    /* @__PURE__ */ jsxs("section", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx(GGScatterPanel, { samples }),
                        }),
                        /* @__PURE__ */ jsx("div", {
                          className: "flex-shrink-0",
                          children: /* @__PURE__ */ jsx(F1TyreDisplay, { t }),
                        }),
                      ],
                    }),
                  ],
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("div", {
                      ...
                      children: /* @__PURE__ */ jsx(F1SectorComparison, { t }),
                    }),
                    /* @__PURE__ */ jsx("div", {
                      className: "col-span-4 overflow-auto",
                      children: /* @__PURE__ */ jsx(LiveCoach, { t }),
                    }),
                  ],
                }),
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("div", {
                      ...
                      children: t.connected
                        ? /* @__PURE__ */ jsx(RecordingControls, { t })
                        : /* @__PURE__ */ jsx(BridgeInstall, { iracingLive: t.connected }),
                    }),
                    /* @__PURE__ */ jsx("div", {
                      className:
                        "col-span-12 md:col-span-6 lg:col-span-3 flex flex-col justify-between",
                      children: /* @__PURE__ */ jsx(GearAdvisor, { t, samples }),
                    }),
                    /* @__PURE__ */ jsx("div", {
                      className:
                        "col-span-12 md:col-span-6 lg:col-span-3 flex flex-col justify-between",
                      children: /* @__PURE__ */ jsx(AdvisorButton, { t }),
                    }),
                    /* @__PURE__ */ jsx("div", {
                      className:
                        "col-span-12 md:col-span-6 lg:col-span-2 flex flex-col justify-between",
                      children: /* @__PURE__ */ jsx(LiveReference, { t }),
                    }),
                    /* @__PURE__ */ jsx("div", {
                      className:
                        "col-span-12 md:col-span-6 lg:col-span-2 flex flex-col justify-between relative",
                      children: /* @__PURE__ */ jsx(FingerprintUploadCard, {}),
                    }),
                  ],
                }),
              ],
                    ...
                    /* @__PURE__ */ jsxs("section", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx(ConfigurableChannelList, { t }),
                        }),
                        /* @__PURE__ */ jsx("div", {
                          className: "border-b border-[#1C2430] bg-[#0B0F14]",
                          children: /* @__PURE__ */ jsx(SectorPanel, { t }),
                        }),
                        /* @__PURE__ */ jsx("div", {
                          className: "flex-1 min-h-0 overflow-y-auto bg-[#0B0F14]",
                          children: /* @__PURE__ */ jsx(TirePanel, { t }),
                        }),
                      ],
                    }),
                    /* @__PURE__ */ jsxs("section", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", {
                          ...
                          children: [
                            /* @__PURE__ */ jsx(PanelHeader, {
                              ...
                              right: cursor
                                ? `cursor delta t=${(cursor.sample.t / 1e3).toFixed(3)}s`
                            ...
                            /* @__PURE__ */ jsxs("div", {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsx("div", {
                                  ...
                                  children: Object.keys(WORKSPACE_PRESETS).map((key) => {
                                    const isActive = activePreset === key;
                                    return /* @__PURE__ */ jsx(
                                      "button",
                                      {
                                        onClick: () => setActivePreset(key),
                                        className: `px-2 py-0.5 text-[8px] uppercase tracking-wider font-bold cursor-pointer ${isActive ? "bg-[#8B5CF6] text-white" : "text-[#7A828C] hover:text-[#E2E4E8]"}`,
                        ...
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx("div", {
                            ...
                            children: WORKSPACE_PRESETS[activePreset].instruments.map(
                              (instrumentKey) => {
                                ...
                                return /* @__PURE__ */ jsx(
                                  ...
                                  {
                                    className: "h-full",
                                    children: /* @__PURE__ */ jsx(InstrumentComponent, {
                                      telemetry: t,
                                      mode: "live",
                                    }),
                                  },
                    ...
                    /* @__PURE__ */ jsxs("section", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx(TabedAnalysisPanel, {
                            samples,
                            ggScatterComponent: /* @__PURE__ */ jsx(GGScatterPanel, { samples }),
                          }),
                        }),
                        /* @__PURE__ */ jsx("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("select", {
            ...
            className:
              "bg-transparent text-foreground border-none font-mono text-[10px] uppercase tracking-wider focus:outline-none cursor-pointer pr-1",
            children: LAYOUT_PROFILES.map((p) =>
              /* @__PURE__ */ jsx(
                "option",
                {
                  value: p.id,
...
function Field({ label, value, mono, valueClass = "" }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("span", {
        className: `${mono ? "tabular-nums" : ""} text-foreground ${valueClass}`,
        children: value,
      }),
    ],
  });
}
function RpmBar({ rpm, warn, red, max }) {
...
function FilterControls({ mode, window: win, onMode, onWindow }) {
  const modes = [
    {
      k: "none",
      label: "RAW",
        ...
        children: modes.map((m) =>
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              onClick: () => onMode(m.k),
              className: `px-2 py-0.5 ${mode === m.k ? "bg-accent text-foreground" : "bg-background text-muted-foreground hover:text-foreground"}`,
              children: m.label,
            },
            m.k,
          ),
        ...
        children: rows.map(({ key, idx }) => {
          ...
          return /* @__PURE__ */ jsxs(
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", {
                  className: `size-1.5 rounded-full ${!time ? "bg-zinc-700" : isBest ? "bg-emerald-500" : "bg-rose-500"}`,
                }),
                /* @__PURE__ */ jsxs("span", {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("div", {
        ...
        children: corners.map(({ key, label }) => {
          const c = t.tires[key];
          return /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", {
                      className: `text-[9px] uppercase ${stateColor(c.state)}`,
                      children: c.state,
                    }),
                  ],
                }),
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("span", {
                      ...
                      children: [Math.round(c.tempC), "°"],
                    }),
                    /* @__PURE__ */ jsxs("span", {
                      className: "text-[10px] text-muted-foreground",
                      children: [c.pressureBar.toFixed(2), " bar"],
                    }),
                  ],
                }),
                /* @__PURE__ */ jsx("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("span", {
            children: [
              ...
              /* @__PURE__ */ jsx("span", {
                className: "text-foreground",
                children: t.safetyRating.toFixed(2),
              }),
            ],
          }),
        ],
...
function GGScatterPanel({ samples }) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsx(PanelHeader, {
          title: "G-G Diagram",
          right: `${samples.length} pts`,
        }),
      }),
      /* @__PURE__ */ jsx("div", {
        className: "flex-1 min-h-0 overflow-hidden",
        children: /* @__PURE__ */ jsx(GGScatter, { samples }),
      }),
    ],
  });
}
