              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("span", { children: [doneCount, " shipped"] }),
                      /* @__PURE__ */ jsxs("span", {
                        className: "font-mono font-bold text-primary",
                        children: [pct, "%"],
                      }),
                      /* @__PURE__ */ jsxs("span", {
                        children: [totalCount - doneCount, " to go"],
                      }),
                    ],
                  }),
                  /* @__PURE__ */ jsx("div", {
                    ...
                    /* @__PURE__ */ jsxs("div", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxs("div", {
                          children: [
                            /* @__PURE__ */ jsx("h2", {
                              className: `text-lg font-bold ${phase.color}`,
                              children: phase.label,
                            }),
                            /* @__PURE__ */ jsxs("p", {
                              className: "text-xs text-muted-foreground mt-0.5",
                              children: [phaseDone, "/", phaseTotal, " complete"],
                            }),
                          ],
                        }),
                        /* @__PURE__ */ jsx("div", {
                    ...
                    /* @__PURE__ */ jsx("div", {
                      ...
                      children: phase.items.map((item) =>
                        /* @__PURE__ */ jsxs(
                          "div",
                          {
                            className: `flex items-start gap-4 rounded-lg border px-4 py-3.5 transition-colors ${item.done ? "border-racing-green/20 bg-racing-green/5" : "border-border bg-panel"}`,
                            children: [
                              /* @__PURE__ */ jsx("div", {
                                ...
                                children: item.done
                                  ...
                                  : /* @__PURE__ */ jsx(Circle, { className: "h-5 w-5" }),
                              }),
                              /* @__PURE__ */ jsx("div", {
