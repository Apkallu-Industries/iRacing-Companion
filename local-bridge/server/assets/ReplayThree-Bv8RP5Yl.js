...
import { e as exportCanvasAsPng } from "./SectorSpider-BJK78UEG.js";
...
function buildTrackGeometry(parsed) {
  ...
  if (!xy) return null;
  const altCh = parsed.channels["Alt"] ?? parsed.channels["Altitude"] ?? parsed.channels["LapDistAlt"];
...
function CarMarker({ position, color }) {
  ...
  return /* @__PURE__ */ jsxs("mesh", { ref, children: [
    ...
    /* @__PURE__ */ jsx("meshStandardMaterial", { color, emissive: color, emissiveIntensity: 0.4 })
  ] });
}
...
function ReplayThree({ parsed }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxs("div", { className: "hairline-b flex items-center justify-between gap-2 px-3 py-1.5 font-mono text-[11px] uppercase tracking-wider text-muted-foreground", children: [
      /* @__PURE__ */ jsxs("span", { children: [
        "3D Replay ",
        geom.hasAlt ? "· elevation" : "· flat (no alt channel)"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        cmpLap != null && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              showGhost ? /* @__PURE__ */ jsx(Eye, { className: "h-3 w-3" }) : /* @__PURE__ */ jsx(EyeOff, { className: "h-3 w-3" }),
              " Ghost"
            ]
          }
        ),
    ...
    /* @__PURE__ */ jsx("div", { ref: containerRef, className: "min-h-0 flex-1", children: /* @__PURE__ */ jsx(
      Canvas,
      {
        ...
        children: /* @__PURE__ */ jsxs(Suspense, { fallback: null, children: [
          ...
          /* @__PURE__ */ jsx("gridHelper", { args: [200, 40, "#2a2f36", "#22262b"], position: [0, -0.01, 0] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "hairline-t flex items-center gap-2 px-3 py-1.5 font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "w-24 text-right tabular-nums", children: refLapObj ? `${((sliderVal - sliderMin) / Math.max(1, sliderMax - sliderMin) * 100).toFixed(0)}%` : `t=${sliderVal}` })
    ] })
  ] });
}
export {
