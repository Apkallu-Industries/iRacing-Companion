import { z } from "zod";
const MATH_V1_MAX_EXPRESSION_LEN = 256;
const MATH_V1_MAX_IDENTIFIERS = 32;
const KEY_RE = /^[a-z][a-z0-9_]*$/;
const UNIT_RE = /^[A-Za-z0-9%/._+\- ]{0,16}$/;
const COLOR_RE = /^#([0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/;
const MathScopeSchema = z.enum(["live", "workbench", "both"]);
const MathExpressionSchema = z.object({
  id: z.string().uuid(),
