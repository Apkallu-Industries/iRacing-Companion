import { d as L, j as e } from "./react-core-hSJfnumv.js";
import { a0 as he } from "./index-BF1LFLDu.js";
import { c as fe } from "./sessions._id-B41VMAUJ.js";
import {
  ak as ge,
  aU as be,
  ap as ve,
...
import "./parseInWorker-Dftmetwb.js";
import "./histogramUtils-mG0ktSUz.js";
import "./registry-DIFZ_TvW.js";
import "./AppHeader-CjQcEoTJ.js";
import "./zod-Dtfr8j2K.js";
import "./tts.functions-LY4Ks8GB.js";
import "./BackButton-Doz18YZJ.js";
import "./useRuntimeStatus-CE4IlwRK.js";
import "./serialize-C4guDAgt.js";
import "./SectorSpider-CrjqgUgQ.js";
import "./setup-HNiGt18E.js";
import "./fingerprint.functions-BMQvC9Av.js";
import "./carClass-DFEFUkyR.js";
const F = {
    speed: "Speed",
    rpm: "RPM",
    gear: "Gear",
  ...
  re = "apextrace.hud.v1";
function ee() {
  if (typeof window > "u") return { config: F, speedUnit: "kmh" };
  try {
    const r = localStorage.getItem(re);
    if (!r) return { config: F, speedUnit: "kmh" };
    const n = JSON.parse(r);
    return { config: { ...F, ...(n.config ?? {}) }, speedUnit: n.speedUnit ?? "kmh" };
  } catch {
    return { config: F, speedUnit: "kmh" };
  }
}
function Le(r) {
  if (!(typeof window > "u"))
...
const U = "apextrace:hud-change";
function ne() {
  const [r, n] = L.useState(() => ee());
  L.useEffect(() => {
    const x = () => n(ee());
    return (
      window.addEventListener(U, x),
      window.addEventListener("storage", x),
      () => {
        (window.removeEventListener(U, x), window.removeEventListener("storage", x));
      }
    );
  }, []);
  const o = (x) => {
    (Le(x), n(x), window.dispatchEvent(new CustomEvent(U)));
  };
  return [r, o, () => o({ config: F, speedUnit: "kmh" })];
}
const te = {
...
function Me({ parsed: r, onClose: n }) {
  const [o, j, x] = ne(),
    T = L.useMemo(() => [...r.channelNames].sort((a, i) => a.localeCompare(i)), [r.channelNames]),
    A = (a, i) => j({ ...o, config: { ...o.config, [a]: i } });
  return e.jsx("div", {
    className:
    ...
    children: e.jsxs("div", {
      ...
      children: [
        e.jsxs("div", {
          ...
          children: [
            e.jsx("span", { children: "HUD layout" }),
            e.jsxs("div", {
              ...
              children: [
                e.jsxs("button", {
                  ...
                  children: [e.jsx(ge, { className: "h-3 w-3" }), " Reset"],
                }),
                e.jsx("button", {
                  onClick: n,
                  className:
                  ...
                  "aria-label": "Close",
                  children: e.jsx(be, { className: "h-3.5 w-3.5" }),
                }),
              ],
            }),
          ],
        ...
        e.jsxs("div", {
          ...
          children: [
            e.jsx("span", { className: "text-muted-foreground", children: "Speed unit" }),
            e.jsx("div", {
              className: "flex gap-px overflow-hidden rounded-sm border border-border",
              children: ["kmh", "mph", "ms"].map((a) =>
                e.jsx(
                  "button",
                  {
                    onClick: () => j({ ...o, speedUnit: a }),
                    className: `px-2 py-0.5 text-[10px] uppercase ${o.speedUnit === a ? "bg-primary text-primary-foreground" : "bg-rail text-muted-foreground hover:text-foreground"}`,
                    children: a === "kmh" ? "km/h" : a === "mph" ? "mph" : "m/s",
                  },
                  a,
                ),
              ),
        ...
        e.jsx("div", {
          ...
          children: e.jsx("div", {
            ...
            children: Object.keys(te).map((a) => {
              const i = te[a],
                h = o.config[a],
                M = !h || h in r.channels,
                g = h ? fe(h) : null,
                f = h ? r.channels[h] : void 0;
              return e.jsxs(
                "label",
                {
                  ...
                  children: [
                    ...
                    e.jsxs("select", {
                      ...
                      children: [
                        ...
                        T.map((d) => e.jsx("option", { value: d, children: d }, d)),
                      ],
                    }),
                    e.jsxs("div", {
                      className:
...
function $(r) {
  ...
  const n = Math.floor(r / 60),
    o = r - n * 60;
  return n > 0 ? `${n}:${o.toFixed(2).padStart(5, "0")}` : o.toFixed(2);
}
function W({ items: r }) {
  return e.jsx("div", {
    className:
            ...
            e.jsxs("span", {
              ...
              children: [
                e.jsx("span", {
                  ...
                  children:
                    n.value == null || !isFinite(n.value)
                      ? "—"
                      : (n.fmt ? n.fmt(n.value) : n.value.toFixed(2)) +
                        (n.unit ? ` ${n.unit}` : ""),
                }),
                e.jsx("span", {
...
function Ye({ parsed: r }) {
  const {
    ...
    g = r.meta.numTicks,
    f = L.useMemo(
      () => r.laps.find((t) => n >= t.startTick && n <= t.endTick) ?? r.laps[0],
      [r.laps, n],
    ),
    d = r.channels,
    c = (t) => (t && d[t] ? d[t].data[n] : void 0),
    s = i.config,
    se = c(s.speed) ?? 0,
    ae = i.speedUnit === "kmh" ? 3.6 : i.speedUnit === "mph" ? 2.23694 : 1,
    _ = se * ae,
    B = i.speedUnit === "kmh" ? "KM/H" : i.speedUnit === "mph" ? "MPH" : "M/S",
    G = c(s.rpm) ?? 0,
    oe = d[s.rpm]?.max ?? 9e3,
    S = Math.round(c(s.gear) ?? 0),
    z = v(c(s.throttle) ?? 0),
    D = v(c(s.brake) ?? 0),
    H = v(c(s.clutch) ?? 0),
    R = c(s.steer) ?? 0,
    le = c(s.steerMax) ?? Math.max(Math.PI, d[s.steer]?.max ?? Math.PI),
    C = (c(s.latG) ?? 0) / 9.81,
    P = (c(s.longG) ?? 0) / 9.81,
    I = c(s.lapTime) ?? 0,
    y = v(c(s.lapPct) ?? 0),
    ...
    b = (t, l, u = 100, m = 100) => {
      ...
      return [u + Math.cos(p) * t, m + Math.sin(p) * t];
    },
    ce = (() => {
      const [l, u] = b(78, k),
        [m, p] = b(78, X),
        w = X - k > 180 ? 1 : 0;
      return `M ${l.toFixed(2)} ${u.toFixed(2)} A 78 78 0 ${w} 1 ${m.toFixed(2)} ${p.toFixed(2)}`;
    })(),
    de = (() => {
      const [l, u] = b(78, k),
        [m, p] = b(78, K);
      return `M ${l.toFixed(2)} ${u.toFixed(2)} A 78 78 0 1 1 ${m.toFixed(2)} ${p.toFixed(2)}`;
    })(),
    me = -Math.max(-360, Math.min(360, (R / Math.max(0.1, le)) * 180)),
    Y = (() => {
      const m = -90 + 360 * y,
        [p, w] = b(46, m, 50, 50);
      return y <= 0.001
        ? ""
        : `M 50 4 A 46 46 0 ${y > 0.5 ? 1 : 0} 1 ${p.toFixed(2)} ${w.toFixed(2)}`;
    })(),
    N = 2.5,
    xe = 50 + v((C + N) / (2 * N)) * 100 - 50,
    ue = 50 - v((P + N) / (2 * N)) * 100 + 50,
    q = (t) => o(Math.max(0, Math.min(g - 1, n + t))),
    Q = (t) => {
      const l = r.laps.findIndex((m) => m.lap === f?.lap);
      if (l < 0) return;
      const u =
        t === "prev" ? r.laps[Math.max(0, l - 1)] : r.laps[Math.min(r.laps.length - 1, l + 1)];
      o(u.startTick);
    };
  return e.jsxs("div", {
    className:
    ...
    children: [
      e.jsxs("div", {
        ...
        children: [
          e.jsxs("span", { children: ["Cinema · L", O, a === O ? " · ref" : ""] }),
          e.jsxs("div", {
            className: "flex items-center gap-2",
            children: [
              e.jsx("span", { className: "tabular-nums", children: $(I) }),
              e.jsxs("button", {
                onClick: () => M(!0),
                className:
                  "flex h-5 items-center gap-1 rounded-sm border border-border px-1.5 text-[10px] hover:text-foreground",
                title: "Customize HUD",
                children: [e.jsx(ve, { className: "h-3 w-3" }), " Layout"],
              }),
            ],
          }),
        ],
            ...
            children: [
              e.jsx(W, {
                items: [
                  ...
                  { label: "RPM", channel: s.rpm, value: G, unit: "rpm", fmt: (t) => t.toFixed(0) },
                  {
                    label: "Gear",
                    channel: s.gear,
                    value: S,
                    fmt: (t) => (t === 0 ? "N" : t === -1 ? "R" : String(t)),
                  },
                ],
              }),
              e.jsxs("svg", {
                ...
                children: [
                  ...
                  e.jsx("path", {
                    d: ce,
                    fill: "none",
                    stroke: J > 0.92 ? "var(--ch-brake)" : "var(--primary)",
                    strokeWidth: 6,
                    strokeLinecap: "round",
                    style: { transition: "stroke 60ms linear" },
                  }),
                  Array.from({ length: 11 }).map((t, l) => {
                    const u = l / 10,
                      m = k + V * u,
                      [p, w] = b(72, m),
                      [Z, pe] = b(82, m);
                ...
                children: [
                  e.jsxs("g", {
                    ...
                    children: [
                      ...
                      e.jsx("circle", { cx: 60, cy: 60, r: 8, fill: "var(--primary)" }),
                      e.jsx("line", {
                        x1: 60,
                        y1: 12,
                        x2: 60,
                  ...
                  e.jsxs("text", {
                    ...
                    fill: "var(--muted-foreground)",
                    className: "tabular-nums",
                    children: [((R * 180) / Math.PI).toFixed(0), "°"],
                  }),
                ],
              }),
              e.jsx("div", {
                ...
                children: [
                  { k: "T", v: z, color: "var(--ch-throttle)" },
                  { k: "B", v: D, color: "var(--ch-brake)" },
                  { k: "C", v: H, color: "var(--ch-default)" },
                ].map((t) =>
                  e.jsxs(
                    "div",
                    {
            ...
            children: [
              e.jsx(W, {
                items: [
                  ...
                  { label: "Lap time", channel: s.lapTime, value: I, unit: "s", fmt: (t) => $(t) },
                ],
              }),
              e.jsx("div", {
                className: "relative",
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("span", { className: "text-muted-foreground", children: "LAT" }),
                      e.jsxs("span", {
                        className: "tabular-nums",
                        children: [C >= 0 ? "+" : "", C.toFixed(2), "g"],
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1",
                    children: [
                      e.jsx("span", { className: "text-muted-foreground", children: "LONG" }),
                      e.jsxs("span", {
                        className: "tabular-nums",
                        children: [P >= 0 ? "+" : "", P.toFixed(2), "g"],
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1",
                    children: [
                      e.jsx("span", { className: "text-muted-foreground", children: "PCT" }),
                      e.jsxs("span", {
                        className: "tabular-nums",
                        children: [(y * 100).toFixed(1), "%"],
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    className: "flex items-center justify-between rounded-sm bg-rail px-2 py-1",
                    children: [
                      e.jsx("span", { className: "text-muted-foreground", children: "FUEL" }),
                      e.jsx("span", {
                        className: "tabular-nums",
                        children: E != null ? `${E.toFixed(1)}L` : "—",
                      }),
                    ],
                  }),
                ],
      ...
      e.jsxs("div", {
        ...
        children: [
          ...
          e.jsx("button", {
            onClick: () => q(-Math.round(r.meta.tickRate)),
            className:
              "flex h-7 w-7 items-center justify-center rounded-sm border border-border text-muted-foreground hover:text-foreground",
            title: "−1s",
          ...
          e.jsx("button", {
            ...
            children: j ? e.jsx(ke, { className: "h-4 w-4" }) : e.jsx(Ne, { className: "h-4 w-4" }),
          }),
          e.jsx("button", {
            onClick: () => q(Math.round(r.meta.tickRate)),
            className:
          ...
          e.jsx("select", {
            value: T,
            onChange: (t) => A(parseFloat(t.target.value)),
            className: "rounded-sm border border-border bg-rail px-2 py-1 font-mono text-xs",
            title: "Playback speed",
            children: [0.25, 0.5, 1, 2, 4, 8].map((t) =>
              e.jsxs("option", { value: t, children: [t, "×"] }, t),
            ),
          }),
          e.jsx("input", {
            type: "range",
            ...
            max: Math.max(0, g - 1),
            value: n,
            onChange: (t) => o(parseInt(t.target.value, 10)),
            className: "flex-1 accent-[color:var(--primary)]",
          }),
          e.jsxs("div", {
            className: "font-mono text-[10px] tabular-nums text-muted-foreground",
            children: [$(n / r.meta.tickRate), " /", " ", $((g - 1) / r.meta.tickRate)],
          }),
        ],
      }),
      h && e.jsx(Me, { parsed: r, onClose: () => M(!1) }),
    ],
  });
}
export { Ye as CinemaPlayback };
