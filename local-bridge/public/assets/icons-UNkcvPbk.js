import { d } from "./react-core-hSJfnumv.js";
const k = (...t) =>
  t
  ...
  (
    ...
    d.createElement(
      "svg",
      {
        ...
        className: k("lucide", y),
        ...(!h && !v(n) && { "aria-hidden": "true" }),
        ...n,
      },
      [...r.map(([p, l]) => d.createElement(p, l)), ...(Array.isArray(h) ? h : [h])],
    ),
);
const a = (t, e) => {
  const c = d.forwardRef(({ className: o, ...y }, h) =>
    d.createElement(m, {
      ref: h,
      iconNode: e,
...
const E = [
  ...
  O2 = a("circle-x", E);
const U = [["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]],
  I2 = a("circle", U);
const G = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const g1 = [
  ...
  f0 = a("lightbulb", g1);
const $1 = [["path", { d: "M21 12a9 9 0 1 1-6.219-8.56", key: "13zald" }]],
  z0 = a("loader-circle", $1);
const N1 = [
...
const t2 = [
  ...
  ya = a("square-check-big", t2);
const c2 = [["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }]],
  na = a("square", c2);
const o2 = [
    [
      "path",
...
const h2 = [
  ...
  ka = a("terminal", h2);
const d2 = [["path", { d: "M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z", key: "17jzev" }]],
  ra = a("thermometer", d2);
const y2 = [
