...
import { b as t } from "./index-BF1LFLDu.js";
import {
  A as n,
  aL as o,
  K as i,
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("h1", {
                ...
                children: [
                  "From ",
                  e.jsx("span", { className: "text-primary", children: "binary tick stream" }),
                  e.jsx("br", {}),
              ...
              e.jsxs("p", {
                ...
                children: [
                  ...
                  e.jsx("code", { className: "font-mono text-foreground", children: ".ibt" }),
                  " ",
                  ...
                  children: [
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx(a.icon, { className: "h-4 w-4 text-primary" }),
                      ],
                    }),
                    e.jsx("h4", { className: "mt-6 text-base font-medium", children: a.h }),
                    e.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: a.p }),
                  ],
                },
                a.n,
              ),
              ...
              children: [
                ...
                e.jsxs("p", {
                  ...
                  children: [
                    ...
                    e.jsx("code", { className: "font-mono", children: "Float" }),
                    ",",
                    " ",
                    e.jsx("code", { className: "font-mono", children: "Double" }),
                    ", ",
                    e.jsx("code", { className: "font-mono", children: "Int" }),
                    ",",
                    " ",
                    e.jsx("code", { className: "font-mono", children: "Bitfield" }),
                    ", ",
                    e.jsx("code", { className: "font-mono", children: "Bool" }),
            ...
            children: [
              ...
              e.jsxs(
                "div",
                {
                  className: "bg-panel p-6",
                  children: [
                    e.jsx(a.icon, { className: "h-5 w-5 text-primary" }),
                    e.jsx("h4", { className: "mt-4 text-base font-medium", children: a.h }),
                    e.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: a.p }),
                  ],
                },
                a.h,
        ...
        children: e.jsxs("div", {
          ...
          children: [
            ...
            e.jsxs("div", {
              className: "bg-panel p-6",
              children: [
                e.jsx(h, { className: "h-5 w-5 text-primary" }),
                e.jsx("h4", { className: "mt-4 text-base font-medium", children: "Yours alone" }),
                e.jsx("p", {
                  className: "mt-2 text-sm text-muted-foreground",
                  children:
            ...
            children: [
              ...
              e.jsxs(
                "div",
                {
                  ...
                  children: [
                    e.jsx("dt", { className: "text-base font-medium", children: a.q }),
                    e.jsx("dd", { className: "mt-2 text-sm text-muted-foreground", children: a.a }),
                  ],
                },
                a.q,
              ),
