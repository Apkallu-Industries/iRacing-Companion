...
import { N as L, a0 as A, b as r, G as M } from "./index-BF1LFLDu.js";
import {
  R as g,
  i as F,
  D as j,
...
function ee() {
    ...
    p = async (s) => {
      ...
      try {
        (await fetch("http://localhost:3001/api/game/config", {
          ...
          body: JSON.stringify({ game: s }),
        }),
          console.log(`[Landing] Synergized bridge config for ${s}`));
      } catch (n) {
        console.warn("[Landing] Local bridge not reachable for game configuration update:", n);
      }
    },
    m =
      typeof window < "u" &&
    ...
    const s = async () => {
      try {
        if (window.pitWallRuntime?.getRuntimeManifest) {
          const l = await window.pitWallRuntime.getRuntimeManifest();
          R(l);
        }
      } catch (l) {
        console.warn("Failed to fetch manifest", l);
      }
    };
    s();
    const n = setInterval(s, 3e3);
    return () => clearInterval(n);
  }, [m]),
    i.useEffect(() => {
      const s = async () => {
        try {
          const l = await fetch("http://localhost:3001/api/license").catch(() => null);
          v(l ? l.ok : !1);
        } catch {
          v(!1);
        }
      ...
      s();
      const n = setInterval(s, 5e3);
      return () => clearInterval(n);
    }, []),
    i.useEffect(() => {
      if (!c) return;
      (async () => {
        const { data: n, error: l } = await M.from("telemetry_sessions")
          .select("*")
  ...
  const y = () => {
    ...
    I = (s) => {
      ...
      const n = Math.floor(s / 60),
        l = (s - n * 60).toFixed(3);
      return `${n}:${l.padStart(6, "0")}`;
    },
    f = t?.totalRamGb ? parseFloat(t.totalRamGb) : 16,
    u = t?.vramGb ? parseFloat(t.vramGb) : 0;
  let h = "Cloud API Mode (OpenAI/Anthropic)",
    d = "#",
    x = "Configure Cloud API →",
    b =
  ...
  return (
    f >= 64 && u >= 16
      ? ((h = "Qwen-2.5-72B-Instruct (Q4_K_M)"),
        (d = "https://huggingface.co/lmstudio-community/Qwen2.5-72B-Instruct-GGUF"),
        (x = "Download GGUF →"),
        (b =
          "Elite-tier offline strategy & tool use. Runs fully offline with 72B parameter reasoning using 48GB System RAM and 16GB VRAM."))
      : f >= 32 && u >= 12
        ? ((h = "Qwen-2.5-14B-Instruct (Q4_K_M)"),
          (d = "https://huggingface.co/lmstudio-community/Qwen2.5-14B-Instruct-GGUF"),
          (x = "Download GGUF →"),
          (b =
            "Perfect balance of speed and outstanding native tool-calling strategy. Fits comfortably inside 12GB VRAM."))
        : f >= 16 &&
          u >= 6 &&
          ((h = "Qwen-2.5-7B-Instruct (Q4_K_M)"),
          (d = "https://huggingface.co/lmstudio-community/Qwen2.5-7B-Instruct-GGUF"),
          (x = "Download GGUF →"),
          (b =
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsxs("span", {
                      ...
                      children: [
                        e.jsx("span", {
                          className: `h-1.5 w-1.5 rounded-full bg-[#00D17F] shadow-[0_0_8px_#00D17F] ${B ? "animate-ping" : ""}`,
                        }),
                        e.jsx("span", {
                          className:
                            "text-[8px] font-mono text-[#00D17F] font-black tracking-widest",
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsxs("span", {
                                className:
                                  "text-[9px] font-mono tracking-widest text-[#7A828C] bg-[#11161D] px-2 py-0.5 border border-[#1C2430]",
                                children: ["Desktop Suite v", t?.appVersion ?? "1.2.3-alpha"],
                              }),
                            ],
                          }),
                          e.jsxs("h1", {
                            ...
                            children: [
                              ...
                              e.jsx("span", {
                                className:
                                  a === "assettocorsa" ? "text-[#00D17F]" : "text-[#3B82F6]",
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("button", {
                                type: "button",
                                onClick: () => p("iracing"),
                                className: `flex-1 py-1.5 px-3 text-[10px] font-bold uppercase tracking-wider text-center transition-all duration-300 rounded-sm flex items-center justify-center gap-2 ${a === "iracing" ? "bg-[#3B82F6] text-white shadow-[0_0_15px_rgba(59,130,246,0.35)] scale-[1.02]" : "text-[#7A828C] hover:text-white hover:bg-[#11161D] bg-transparent"}`,
                                children: [
                                  e.jsx("span", {
                                    className: `h-1.5 w-1.5 rounded-full ${a === "iracing" ? "bg-white animate-pulse" : "bg-[#7A828C]"}`,
                                  }),
                                  "iRacing Simulator",
                                ],
                              }),
                              e.jsxs("button", {
                                type: "button",
                                onClick: () => p("assettocorsa"),
                                className: `flex-1 py-1.5 px-3 text-[10px] font-bold uppercase tracking-wider text-center transition-all duration-300 rounded-sm flex items-center justify-center gap-2 ${a === "assettocorsa" ? "bg-[#00D17F] text-zinc-950 shadow-[0_0_15px_rgba(0,209,127,0.35)] scale-[1.02] font-black" : "text-[#7A828C] hover:text-white hover:bg-[#11161D] bg-transparent"}`,
                                children: [
                                  e.jsx("span", {
                                    className: `h-1.5 w-1.5 rounded-full ${a === "assettocorsa" ? "bg-zinc-950 animate-pulse" : "bg-[#7A828C]"}`,
                                  }),
                                  "Assetto Corsa",
                                ],
                              }),
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs(r, {
                            ...
                            children: [e.jsx(g, { className: "h-4 w-4" }), "Launch Live Dashboard"],
                          }),
                          e.jsxs(r, {
                            to: "/sessions",
                            className:
                            ...
                            children: [
                              e.jsx(F, { className: "h-4 w-4 text-[#3B82F6]" }),
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs("span", {
                            ...
                            children: [
                              e.jsx(j, { className: "h-3.5 w-3.5 text-[#3B82F6]" }),
                          ...
                          e.jsxs("span", {
                            ...
                            children: [
                              e.jsx("span", { className: "h-1 w-1 bg-[#00D17F] rounded-full" }),
                              "MONITORING",
                            ],
                          }),
                        ],
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsx("span", {
                                ...
                                children: t?.hostname ?? "WORKSTATION-PC",
                              }),
                              e.jsxs("span", {
                                className: "text-[#7A828C] text-[8px]",
                                children: ["OS: ", t?.platform ?? "win32", " · ", t?.arch ?? "x64"],
                              }),
                            ],
                          }),
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsx("span", {
                                ...
                                children: t?.cpuModel
                                  ? t.cpuModel.replace(/\(R\)|\(TM\)/g, "").trim()
                                  : "Detecting...",
                              }),
                              e.jsxs("span", {
                                className: "text-[#7A828C] text-[8px]",
                                children: ["LOGICAL CORES: ", t?.cpuCores ?? 8],
                              }),
                            ],
                          }),
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsxs("div", {
                                ...
                                children: [
                                  e.jsx("span", {
                                    children: t
                                      ? `${(t.totalRamGb - t.freeRamGb).toFixed(1)} GB`
                                      : "0.0 GB",
                                  }),
                                  e.jsxs("span", {
                                    className: "text-[#7A828C]",
                                    children: ["/ ", t?.totalRamGb ?? "16.0", " GB"],
                                  }),
                                ],
                              }),
                              e.jsx("div", {
                                ...
                                children: e.jsx("div", {
                                  ...
                                  style: {
                                    width: t
                                      ? `${((t.totalRamGb - t.freeRamGb) / t.totalRamGb) * 100}%`
                                      : "30%",
                                  },
                                }),
                              }),
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsx("span", {
                                className:
                                  "text-white truncate font-sans text-xs italic tracking-tight font-extrabold",
                                children: t?.gpuModel ?? "Detecting GPU...",
                              }),
                              e.jsxs("div", {
                                className:
                                  "flex items-center justify-between text-white text-[9px] font-mono",
                                children: [
                                  e.jsx("span", { className: "text-[#7A828C]", children: "VRAM:" }),
                                  e.jsx("span", {
                                    className: "font-bold text-[#00D17F]",
                                    children: t?.vramGb
                                      ? `${parseFloat(t.vramGb).toFixed(1)} GB`
                                      : "0.0 GB",
                                  }),
                                ],
                              }),
                                ...
                                children: [
                                  e.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      e.jsx("span", {
                                        className:
                                          t?.mongoStatus === "active"
                                            ? "text-[#00D17F]"
                                            : "text-[#FF4D4D]",
                                        children:
                                          t?.mongoStatus === "active" ? "ACTIVE" : "INACTIVE",
                                      }),
                                    ],
                                  }),
                                  e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("div", {
                                ...
                                children: [
                                  ...
                                  e.jsx("span", {
                                    className:
                                      t?.bridgeStatus === "running"
                                        ? "text-[#00D17F]"
                                        : t?.bridgeStatus === "crashed"
                                          ? "text-[#FF4D4D]"
                                          : "text-[#FFB800]",
                                    children: t?.bridgeStatus
                                      ? String(t.bridgeStatus).toUpperCase()
                                      : "CONNECTING",
                                  }),
                                ],
                              }),
                              e.jsxs("div", {
                                ...
                                children: [
                                  ...
                                  e.jsx("span", {
                                    className: "text-white",
                                    children: t?.uptimeSec
                                      ? `${Math.floor(t.uptimeSec / 3600)}h ${Math.floor((t.uptimeSec % 3600) / 60)}m`
                                      : "0h 0m",
                                  }),
                                ],
                              }),
                    ...
                    children: [
                      ...
                      e.jsxs("h1", {
                        ...
                        children: [
                          "Enter the ",
                          e.jsx("span", {
                            className: a === "assettocorsa" ? "text-[#00D17F]" : "text-[#3B82F6]",
                            children: "Pit Wall",
                          }),
                        ],
                      }),
                      ...
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs(r, {
                            ...
                            className:
                              "inline-flex items-center justify-center gap-2 rounded-sm bg-[#00D17F] hover:bg-[#00B86F] px-6 py-3 font-mono text-xs uppercase font-bold text-zinc-950 transition-all shadow-[0_0_20px_rgba(0,209,127,0.25)] hover:scale-105 cursor-pointer",
                            children: [e.jsx(g, { className: "h-4 w-4" }), "Enter Pit Wall"],
                          }),
                          e.jsxs(r, {
                            to: "/roadmap",
                            className:
                              "inline-flex items-center justify-center gap-2 rounded-sm border border-[#1C2430] bg-[#11161D] hover:bg-[#161C24] px-5 py-3 font-mono text-xs uppercase font-bold text-white transition-all cursor-pointer",
                            children: [e.jsx(D, { className: "h-4 w-4" }), "Get Desktop Installer"],
                          }),
                        ],
                      }),
                    ],
          ...
          children: e.jsxs("div", {
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx(G, { className: "h-3.5 w-3.5 text-[#3B82F6]" }),
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsx("span", {
                            className: `text-[8px] font-bold tracking-widest px-2 py-0.5 border ${w ? "border-[#00D17F]/30 bg-[#00D17F]/10 text-[#00D17F]" : "border-[#7A828C]/30 bg-[#05070A] text-[#7A828C]"}`,
                            children: w ? "ACTIVE" : "SIM READY",
                          }),
                        ],
                      }),
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("h3", {
                            className:
                              "text-xs font-bold text-white tracking-widest uppercase mb-1",
                      ...
                      e.jsxs("span", {
                        ...
                        children: ["RUN LIVE CONSOLE ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs(r, {
                    ...
                    children: [
                      ...
                      e.jsxs("span", {
                        className:
                          "text-[9px] font-bold text-[#3B82F6] group-hover:translate-x-1 transition-transform inline-flex items-center gap-1 mt-2",
                        children: ["PLAN TEAM STRATEGY ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs(r, {
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("span", {
                            className:
                              "p-1.5 rounded border border-[#1C2430] bg-[#0B0F14] text-[#3B82F6]",
                            children: e.jsx(F, { className: "h-5 w-5" }),
                          }),
                          e.jsx("span", {
                            className:
                      ...
                      e.jsxs("span", {
                        className:
                          "text-[9px] font-bold text-[#3B82F6] group-hover:translate-x-1 transition-transform inline-flex items-center gap-1 mt-2",
                        children: ["OPEN WORKBENCH ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs(r, {
                    ...
                    children: [
                      ...
                      e.jsxs("span", {
                        ...
                        children: ["BOOT TERMINAL ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs("a", {
                    ...
                    children: [
                      ...
                      e.jsxs("span", {
                        ...
                        children: ["VIEW ONBOARDING GUIDE ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs(r, {
                    ...
                    children: [
                      ...
                      e.jsxs("span", {
                        ...
                        children: ["READ MANUAL ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs(r, {
                    ...
                    children: [
                      ...
                      e.jsxs("span", {
                        ...
                        children: ["VIEW ROADMAP ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                  e.jsxs("button", {
                    ...
                    children: [
                      ...
                      e.jsxs("span", {
                        ...
                        children: ["OPEN PREFERENCES ", e.jsx(o, { className: "h-3 w-3" })],
                      }),
                    ],
                  }),
                ],
                  ...
                  e.jsxs(r, {
                    ...
                    children: [
                      e.jsxs("span", {
                        ...
                        children: [
                          e.jsx(g, { className: "h-4 w-4 text-[#00D17F]" }),
                  ...
                  e.jsxs(r, {
                    ...
                    children: [
                      e.jsxs("span", {
                        className: "flex items-center gap-2 text-white font-bold",
                        children: [
                          e.jsx(z, { className: "h-4 w-4 text-[#3B82F6]" }),
                          c ? "Active Account Profile Linked" : "ENGINEER LOGIN GATEWAY",
                        ],
                      }),
                      e.jsx("span", {
                        className: "text-[#3B82F6] hover:underline",
                        children: c ? "View profile →" : "Sign in to save records →",
                      }),
                    ],
                  }),
                ],
                      ...
                      r,
                      {
                        ...
                        children: [
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("span", { children: "BEST LAP:" }),
                              e.jsx("span", {
                                className: "text-[#00D17F] font-bold tracking-wider",
                                children: I(s.best_lap_s),
                              }),
                            ],
                          }),
                        ],
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("span", {
                                ...
                                children: [
                                  "STATUS: ",
                                  t?.mongoStatus === "active" ? "ACTIVE" : "OFFLINE",
                                ],
                              }),
                              e.jsx("button", {
                                onClick: async () => {
                                  window.pitWallRuntime?.ensureMongoDB &&
                                    (await window.pitWallRuntime.ensureMongoDB());
                                },
                                disabled: t?.mongoStatus === "active",
                                className:
                        ...
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("div", {
                                ...
                                children: [e.jsx(N, { className: "h-4 w-4" }), " WebSocket Bridge"],
                              }),
                              e.jsx("p", {
                                className: "text-[#7A828C] text-[10px] leading-relaxed",
                                children:
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsx("button", {
                                onClick: async () => {
                                  window.pitWallRuntime?.restartBridge &&
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("span", {
                                ...
                                children: [
                                  "MODE: ",
                                  t?.aiMode ? String(t.aiMode).toUpperCase() : "CLOUD",
                                ],
                              }),
                              e.jsx("button", {
                                onClick: async () => {
                                  window.pitWallRuntime?.refreshAiMode &&
                    ...
                    children: [
                      ...
                      e.jsxs("p", {
                        ...
                        children: [
                          ...
                          e.jsx("span", { className: "font-mono text-white", children: "17777" }),
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsxs("ul", {
                                ...
                                children: [
                                  e.jsx("li", { children: "• Windows 10 or 11 (Host machine)" }),
                                  e.jsx("li", {
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              ...
                              e.jsxs("ul", {
                                ...
                                children: [
                                  e.jsx("li", { children: "• Windows 10 or 11 (Host machine)" }),
                                  e.jsx("li", { children: "• iRacing active simulation running" }),
                                  e.jsx("li", {
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsxs("div", {
                                className:
                                  "flex items-center gap-2 font-mono uppercase tracking-wider text-[#8B5CF6] font-bold",
                                children: [e.jsx(j, { className: "h-4 w-4" }), " 3. Local first"],
                              }),
                              e.jsx("p", {
                                className: "text-[#7A828C] text-[10px] leading-relaxed",
                                children:
          ...
          children: e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("span", { children: "ENGINEERING GRADE" }),
                  e.jsx("span", { children: "·" }),
                  e.jsx("span", { children: "LOCAL MEMORY ONLY" }),
                  e.jsx("span", { children: "·" }),
                  e.jsx("span", { children: "FAST TELEMETRY TRACING" }),
                  e.jsx("span", { children: "·" }),
                  e.jsx("span", { children: "AI STRATEGIST ACTIVE" }),
                ],
              }),
              e.jsxs("div", {
                className: "flex items-center gap-3",
                children: [
                  e.jsx("span", { children: "© 2026 PIT WALL WORKSTATION" }),
                  e.jsx("div", {
                    className:
